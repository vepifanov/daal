...
{
    singleBeta = 0,     /*!< Single coefficient metrics*/
    groupOfBetas = 1    /*!< Group of coefficients metrics*/
};
...
public:
     ...
     */
    services::SharedPtr<algorithms::Result> getResult(QualityMetricId id) const;
};
...
public:
     ...
     */
    services::SharedPtr<algorithms::Input> getInput(QualityMetricId id) const;
};
