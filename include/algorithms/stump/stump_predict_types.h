...
public:
     ...
     * \return          %Input object that corresponds to the given identifier
     */
    services::SharedPtr<stump::Model> get(classifier::prediction::ModelInputId id) const;
     ...
     * \param[in] ptr   Pointer to the input object
     */
    void set(classifier::prediction::ModelInputId id, const services::SharedPtr<stump::Model> &ptr);
