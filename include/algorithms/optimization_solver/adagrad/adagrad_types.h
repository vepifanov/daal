...
enum OptionalDataId
{
    gradientSquareSum = 0, /*!< Numeric table of size 1 x p with the values of G,
...
struct DAAL_EXPORT Parameter : public optimization_solver::iterative_solver::Parameter
{
    ...
    Parameter(
        ...
        data_management::NumericTablePtr                 learningRate_ = data_management::NumericTablePtr(
                                                                             new data_management::HomogenNumericTable<double>(1, 1, data_management::NumericTableIface::doAllocate, 0.01)),
