...
enum OptionalDataId
{
    correctionPairs = 0,            /*!< Correction pairs table. Numeric table 2*m x n, where
                                         rows (0, m-1) represent correction vectors S and
                                         rows (m, 2*m-1) represent correction vectors Y */
    correctionIndices = 1,          /*!< Numeric table of size 1 x 2 with 32-bit integer indexes.
    ...
    averageArgumentLIterations = 2, /*!< Numeric table of size 2 x n, where
