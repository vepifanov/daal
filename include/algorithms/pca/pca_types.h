...
public:
    /** Constructs PCA parameters */
    BatchParameter(const services::SharedPtr<covariance::BatchIface> &covarianceForBatchParameter =
...
public:
    /** Constructs PCA parameters */
    OnlineParameter(const services::SharedPtr<covariance::OnlineIface> &covarianceForOnlineParameter =
                    ...
                    const services::SharedPtr<PartialResultsInitIface<correlationDense> > &initializationProcedureForOnlineParameter =
...
public:
    /** Constructs PCA parameters */
    OnlineParameter(const services::SharedPtr<PartialResultsInitIface<svdDense> > &initializationProcedureForOnlineParameter =
