 ...
 */
template<ComputeMode mode> class AnalysisContainerIface : public AlgorithmContainerIface<mode>
{
public:
    AnalysisContainerIface(daal::services::Environment::env *daalEnv = 0): AlgorithmContainerIface<mode>(daalEnv) {}
};
