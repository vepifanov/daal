...
public:
    ...
    using classifier::prediction::Input::get;
     ...
     */
    services::SharedPtr<kdtree_knn_classification::Model> get(classifier::prediction::ModelInputId id) const;
     ...
     */
    void set(classifier::prediction::ModelInputId id, const services::SharedPtr<kdtree_knn_classification::interface1::Model> & value);
