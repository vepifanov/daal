...
public:
     ...
     */
    services::SharedPtr<daal::algorithms::kdtree_knn_classification::interface1::Model> get(classifier::training::ResultId id) const;
    ...
    DAAL_EXPORT void allocate(const daal::algorithms::Input *input, const Parameter *parameter, int method);

protected:
    /** \private */
    template<typename Archive, bool onDeserialize>
    void serialImpl(Archive *arch) { classifier::training::Result::serialImpl<Archive, onDeserialize>(arch); }
