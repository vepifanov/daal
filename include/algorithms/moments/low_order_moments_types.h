...
{
    estimatesAll          = 0,        /*!< Default: Compute all supported moments */
    estimatesMinMax       = 1,        /*!< MinMAx: Compute minimum and maximum  */
    estimatesMeanVariance = 2         /*!< MeanVariance: Compute mean and variance  */
};
