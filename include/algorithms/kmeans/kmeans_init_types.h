...
{
    internalInput = 1 /*!< %DataCollection with internal algorithm data calculated by previous steps on this node*/
};
...
{
    inputOfStep2 = 2 /*!< %Numeric table with the new centroids calculated by previous steps of initialization algorithm */
};
...
{
    inputOfStep3FromStep2 = 0 /*!< %Numeric table with the data calculated on step2 on local nodes*/
};
...
{
    inputOfStep4FromStep3 = 2 /*!< %Numeric table with the data calculated on step3 on master node */
};
...
{
    inputCentroids = 0,        /*!< %DataCollection of NumericTables with the new centroids */
    inputOfStep5FromStep2 = 1  /*!< %DataCollection of NumericTables with the new centroids rating */
};
...
{
    inputOfStep5FromStep3 = 2  /*!< %Service data generated as the output of step3Master */
};
...
{
    outputOfStep2ForStep3 = 0,  /*!< %Numeric table containing output from step 2 on the local node used by step 3 on a master node*/
    outputOfStep2ForStep5 = 1   /*!< %Numeric table containing output from step 2 on the local node used by step 5 on a master node*/
};
...
{
    internalResult = 2  /*!< %DataCollection with internal algorithm data required as an input for the future steps on the node*/
};
...
{
    outputOfStep3ForStep4 = 0 /*!< %KeyValueDataCollection with the input for local nodes on step 4 */
};
...
{
    rngState = 1,                       /*!< %Service data generated as the output of step3Master to be used in step5Master*/
...
{
    outputOfStep4 = 0 /*!< %NumericTable with the new centroids calculated on step 4 on the local node */
};
...
{
    candidates = 0, /*!< %NumericTable with the new centroids calculated on the previous steps */
    weights    = 1  /*!< %NumericTable with the weights of the new centroids calculated on the previous steps */
};
...
* \snippet kmeans/kmeans_init_types.h Parameter source code
*/
/* [DistributedStep2LocalPlusPlusParameter source code] */
