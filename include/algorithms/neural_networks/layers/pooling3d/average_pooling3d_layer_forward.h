...
/*
//++
//  Implementation of the interface for the forward average three-dimensional (3D) pooling layer
 ...
 */
/**
 * <a name="DAAL-CLASS-ALGORITHMS__NEURAL_NETWORKS__LAYERS__AVERAGE_POOLING3D__FORWARD__BATCHCONTAINER"></a>
...
public:
    /**
     * Constructs a container for the forward average 3D pooling layer with a specified environment
     * in the batch processing mode
    ...
    ~BatchContainer();
    /**
     * Computes the result of the forward average 3D pooling layer in the batch processing mode
     */
...
{
public:
    Parameter &parameter; /*!< Forward average 3D pooling layer \ref interface1::Parameter "parameters" */
    ...
    /**
     * Constructs a forward average 3D pooling layer in the batch processing mode
