/* file: tanh_layer_forward_types.h */
/*******************************************************************************
...
/*
//++
//  Implementation of the forward hyperbolic tangent layer.
//--
*/

#ifndef __TANH_LAYER_FORWARD_TYPES_H__
#define __TANH_LAYER_FORWARD_TYPES_H__
 ...
 * \copydoc daal::algorithms::neural_networks::layers::tanh::forward
 * @ingroup tanh_layers
 * @{
 */
/**
...
public:
    ...
    /**
    * Gets the input of the forward hyperbolic tangent layer
    */
    using layers::forward::Input::get;
    /**
    * Sets the input of the forward hyperbolic tangent layer
    */
...
public:
    ...
    */
    ...
    /**
     * Sets the result that is used in backward hyperbolic tangent layer
     * \param[in] input     Pointer to an object containing the input data
     */
