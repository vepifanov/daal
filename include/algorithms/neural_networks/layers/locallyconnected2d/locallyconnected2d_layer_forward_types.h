/* file: locallyconnected2d_layer_forward_types.h */
/*******************************************************************************
...
/*
//++
//  Implementation of forward two-dimensional (2D) locally connected layer.
//--
*/

#ifndef __LOCALLYCONNECTED2D_LAYER_FORWARD_TYPES_H__
#define __LOCALLYCONNECTED2D_LAYER_FORWARD_TYPES_H__
 ...
 * \copydoc daal::algorithms::neural_networks::layers::locallyconnected2d::forward
...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__NEURAL_NETWORKS__LAYERS__LOCALLYCONNECTED2D__FORWARD__INPUT"></a>
 * \brief %Input objects for the forward 2D locally connected layer
 */
...
public:
    ...
    /**
     * Sets an input object for the forward 2D locally connected layer
     */
    using layers::forward::Input::set;
    /**
     * Returns an input object for the forward 2D locally connected layer
    */
...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__NEURAL_NETWORKS__LAYERS__LOCALLYCONNECTED2D__FORWARD__RESULT"></a>
 * \brief Results obtained with the compute() method of the forward 2D locally connected layer
