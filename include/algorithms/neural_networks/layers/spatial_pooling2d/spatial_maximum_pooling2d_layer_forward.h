...
{
public:
    Parameter &parameter; /*!< Forward spatial pyramid maximum 2D pooling layer \ref interface1::Parameter "parameters" */
    Input input;          /*!< Forward spatial pyramid maximum 2D pooling layer input */
