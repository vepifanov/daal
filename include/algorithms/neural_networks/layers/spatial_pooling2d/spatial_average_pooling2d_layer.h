/* file: spatial_average_pooling2d_layer.h */
/*******************************************************************************
...
#ifndef __SPATIAL_AVERAGE_POOLING2D_LAYER_H__
#define __SPATIAL_AVERAGE_POOLING2D_LAYER_H__
...
#include "algorithms/neural_networks/layers/spatial_pooling2d/spatial_average_pooling2d_layer_forward.h"
#include "algorithms/neural_networks/layers/spatial_pooling2d/spatial_average_pooling2d_layer_backward.h"
 ...
 */
/**
 * <a name="DAAL-CLASS-ALGORITHMS__NEURAL_NETWORKS__LAYERS__SPATIAL_AVERAGE_POOLING2D__BATCH"></a>
 * \brief Provides methods for the spatial pyramid average 2D pooling layer in the batch processing mode
 ...
 *
 * \tparam algorithmFPType  Data type to use in intermediate computations for the spatial pyramid average 2D pooling layer, double or float
 * \tparam method           Spatial pyramid spatial pyramid average 2D pooling layer method, \ref Method
 *
 * \par Enumerations
...
{
public:
    Parameter parameter; /*!< Spatial pyramid spatial pyramid average 2D pooling layer parameters */
