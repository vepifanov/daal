...
enum LayerDataId
{
    auxSelectedIndices = 0,         /*!< p-dimensional tensor that stores the positions of spatial pyramid stochastic elements */
};
...
struct DAAL_EXPORT Parameter: public spatial_pooling2d::Parameter
{
    Parameter(size_t pyramidHeight, size_t firstIndex, size_t secondIndex) :
        spatial_pooling2d::Parameter(pyramidHeight, firstIndex, secondIndex), seed(777)
    {}
