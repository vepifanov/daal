/* file: spatial_maximum_pooling2d_layer_forward_types.h */
/*******************************************************************************
...
/*
//++
//  Implementation of forward spatial pyramid maximum 2D pooling layer.
//--
*/

#ifndef __SPATIAL_MAXIMUM_POOLING2D_LAYER_FORWARD_TYPES_H__
#define __SPATIAL_MAXIMUM_POOLING2D_LAYER_FORWARD_TYPES_H__
 ...
 * \copydoc daal::algorithms::neural_networks::layers::spatial_maximum_pooling2d::forward
...
{
/**
 * <a name="DAAL-CLASS-ALGORITHMS__NEURAL_NETWORKS__LAYERS__SPATIAL_MAXIMUM_POOLING2D__FORWARD__INPUT"></a>
 * \brief %Input objects for the forward spatial pyramid maximum 2D pooling layer
...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__NEURAL_NETWORKS__LAYERS__SPATIAL_MAXIMUM_POOLING2D__FORWARD__RESULT"></a>
 * \brief Provides methods to access the result obtained with the compute() method
 *        of the forward spatial pyramid maximum 2D pooling layer
 */
