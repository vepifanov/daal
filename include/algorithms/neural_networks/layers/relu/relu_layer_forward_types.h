/* file: relu_layer_forward_types.h */
/*******************************************************************************
...
/*
//++
//  Implementation of the forward rectifier linear unit (relu) layer.
//--
*/

#ifndef __RELU_LAYER_FORWARD_TYPES_H__
#define __RELU_LAYER_FORWARD_TYPES_H__
 ...
 * \copydoc daal::algorithms::neural_networks::layers::relu::forward
 * @ingroup relu_layers
 * @{
 */
/**
...
{
/**
 * <a name="DAAL-CLASS-ALGORITHMS__NEURAL_NETWORKS__LAYERS__RELU__FORWARD__INPUT"></a>
 * \brief %Input objects for the forward relu layer
 */
...
public:
    ...
    /**
    * Gets the input of the forward relu layer
    */
    using layers::forward::Input::get;

    /**
    * Sets the input of the forward relu layer
    */
...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__NEURAL_NETWORKS__LAYERS__RELU__FORWARD__RESULT"></a>
 * \brief Provides methods to access the result obtained with the compute() method of the forward relu layer
 */
...
public:
    ...
    */
    ...
    /**
     * Checks the result of the forward relu layer
    ...
    */
    ...
    /**
     * Sets the result that is used in backward relu layer
     * \param[in] input     Pointer to an object containing the input data
     */
