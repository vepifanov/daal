/* file: stochastic_pooling2d_layer_backward.h */
/*******************************************************************************
...
/*
//++
//  Implementation of the interface for the backward stochastic two-dimensional (2D) pooling layer
//  in the batch processing mode
//--
*/

#ifndef __STOCHASTIC_POOLING2D_LAYER_BACKWARD_H__
#define __STOCHASTIC_POOLING2D_LAYER_BACKWARD_H__
...
#include "algorithms/neural_networks/layers/pooling2d/stochastic_pooling2d_layer_backward_types.h"
...
{};
/**
 * <a name="DAAL-CLASS-ALGORITHMS__NEURAL_NETWORKS__LAYERS__STOCHASTIC_POOLING2D__BACKWARD__BATCHCONTAINER_ALGORITHMFPTYPE_DEFAULTDENSE_CPU"></a>
 * \brief Provides methods to run implementations of the backward stochastic 2D pooling layer.
 *        This class is associated with the \ref backward::interface1::Batch "backward::Batch" class
 *        and supports the method of backward stochastic 2D pooling layer computation in the batch processing mode
 *
...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__NEURAL_NETWORKS__LAYERS__STOCHASTIC_POOLING2D__BACKWARD__BATCH"></a>
 * \brief Provides methods for the backward stochastic 2D pooling layer in the batch processing mode
 * \n<a href="DAAL-REF-STOCHASTICPOOLING2DBACKWARD-ALGORITHM">Backward stochastic 2D pooling layer description and usage models</a>
 *
 * \tparam algorithmFPType  Data type to use in intermediate computations for the backward  stochastic 2D pooling layer, double or float
 * \tparam method           Backward stochastic 2D pooling layer method, stochastic_pooling2d::Method
 *
 * \par Enumerations
 *      - \ref Method                      Computation methods for the backward stochastic 2D pooling layer
 *      - \ref backward::InputId           Identifiers of input objects for the backward stochastic 2D pooling layer
 *      - \ref LayerDataId                 Identifiers of collection in input objects for the backward stochastic 2D pooling layer
 *      - \ref backward::InputLayerDataId  Identifiers of extra results computed by the forward stochastic 2D pooling layer
 *      - \ref backward::ResultId          Identifiers of result objects for the backward stochastic 2D pooling layer
 *
 * \par References
...
{
public:
    Parameter &parameter; /*!< Backward stochastic 2D pooling layer \ref interface1::Parameter "parameters" */
    Input input;          /*!< Backward stochastic 2D pooling layer input */
    ...
    /**
     * Constructs a backward stochastic 2D pooling layer by copying input objects
    ...
    /**
     * Registers user-allocated memory to store the result of the backward stochastic 2D pooling layer
    ...
    /**
     * Returns a pointer to a newly allocated backward stochastic 2D pooling layer
