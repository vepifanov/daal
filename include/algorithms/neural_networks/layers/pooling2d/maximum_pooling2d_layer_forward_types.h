/* file: maximum_pooling2d_layer_forward_types.h */
/*******************************************************************************
...
/*
//++
//  Implementation of forward maximum 2D pooling layer.
//--
*/

#ifndef __MAXIMUM_POOLING2D_LAYER_FORWARD_TYPES_H__
#define __MAXIMUM_POOLING2D_LAYER_FORWARD_TYPES_H__
 ...
 * \copydoc daal::algorithms::neural_networks::layers::maximum_pooling2d::forward
...
{
/**
 * <a name="DAAL-CLASS-ALGORITHMS__NEURAL_NETWORKS__LAYERS__MAXIMUM_POOLING2D__FORWARD__INPUT"></a>
 * \brief %Input objects for the forward maximum 2D pooling layer
...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__NEURAL_NETWORKS__LAYERS__MAXIMUM_POOLING2D__FORWARD__RESULT"></a>
 * \brief Provides methods to access the result obtained with the compute() method
 *        of the forward maximum 2D pooling layer
 */
