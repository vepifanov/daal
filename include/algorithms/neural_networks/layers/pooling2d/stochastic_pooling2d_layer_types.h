...
enum LayerDataId
{
    auxSelectedIndices = 0,         /*!< p-dimensional tensor that stores the positions of stochastic elements */
};
...
struct DAAL_EXPORT Parameter: public pooling2d::Parameter
{
    ...
    size_t seed;          /*!< Seed for multinomial distribution random number generator. */
};
/* [Parameter source code] */
