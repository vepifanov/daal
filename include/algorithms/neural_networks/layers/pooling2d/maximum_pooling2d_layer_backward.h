...
/*
//++
//  Implementation of the interface for the backward maximum two-dimensional (2D) pooling layer
 ...
 */
/**
 * <a name="DAAL-CLASS-ALGORITHMS__NEURAL_NETWORKS__LAYERS__MAXIMUM_POOLING2D__BACKWARD__BATCHCONTAINER"></a>
...
public:
    /**
     * Constructs a container for the backward maximum 2D pooling layer with a specified environment
     * in the batch processing mode
    ...
    ~BatchContainer();
    /**
     * Computes the result of the backward maximum 2D pooling layer in the batch processing mode
     */
...
{
public:
    Parameter &parameter; /*!< Backward maximum 2D pooling layer \ref interface1::Parameter "parameters" */
    ...
    /**
     * Constructs a backward maximum 2D pooling layer in the batch processing mode
