/* file: stochastic_pooling2d_layer.h */
/*******************************************************************************
...
#ifndef __STOCHASTIC_POOLING2D_LAYER_H__
#define __STOCHASTIC_POOLING2D_LAYER_H__
 ...
 */
/**
 * <a name="DAAL-CLASS-ALGORITHMS__NEURAL_NETWORKS__LAYERS__STOCHASTIC_POOLING2D__BATCH"></a>
 * \brief Provides methods for the stochastic 2D pooling layer in the batch processing mode
 ...
 *
 * \tparam algorithmFPType  Data type to use in intermediate computations for the stochastic 2D pooling layer, double or float
 * \tparam method           Stochastic 2D pooling layer method, \ref Method
 *
 * \par Enumerations
...
{
public:
    Parameter parameter; /*!< Stochastic 2D pooling layer parameters */

    /**
     * Constructs the stochastic 2D pooling layer
