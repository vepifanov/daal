...
/*
//++
//  Implementation of the interface for the forward dropout layer in the batch processing mode
//--
*/

#ifndef __DROPOUT_LAYER_FORWARD_H__
#define __DROPOUT_LAYER_FORWARD_H__
 ...
 */
/**
 * <a name="DAAL-CLASS-ALGORITHMS__NEURAL_NETWORKS__LAYERS__DROPOUT__FORWARD__BATCHCONTAINER"></a>
...
public:
    /**
     * Constructs a container for the forward dropout with a specified environment
    ...
    ~BatchContainer();
    /**
     * Computes the result of the forward dropout layer in the batch processing mode
     */
...
{
public:
    Parameter &parameter; /*!< Forward dropout layer \ref interface1::Parameter "parameters" */
    ...
    /**
     * Constructs a forward dropout layer in the batch processing mode
