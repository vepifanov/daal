...
public:
    ...
    /** \brief Constructor */
    Model() : _backwardLayers(new BackwardLayers()), _solverOptionalArgumentCollection(), _storeWeightDerivativesInTable(false) {}
...
public:
     ...
     * \param index Index in collection of required OptionalArgument
     */
    void setSolverOptionalArgument(const algorithms::OptionalArgumentPtr& solverOptionalArgument, size_t index)
    {
     ...
     */
    void setSolverOptionalArgumentCollection(const data_management::DataCollection &solverOptionalArgumentCollection)
    {
