...
public:
     ...
     */
    virtual services::SharedPtr<DataBlockCollection> getCompressedBlocksCollection();
    /**
...
public:
     ...
     */
    virtual services::SharedPtr<DataBlockCollection> getDecompressedBlocksCollection();
    /**
