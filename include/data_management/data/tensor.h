...
public:
     ...
     *  \param[out] subtensor    The subtensor descriptor.
     */
    virtual void getSubtensor(size_t fixedDims, const size_t* fixedDimNums, size_t rangeDimIdx, size_t rangeDimNum,
...
public:
    ...
    virtual bool check(services::ErrorCollection *errors, const char *description) const DAAL_C11_OVERRIDE
    {
        ...
        {
            services::SharedPtr<services::Error> error = services::SharedPtr<services::Error>(new services::Error(services::ErrorNullTensor));
