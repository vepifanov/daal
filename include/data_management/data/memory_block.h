...
public:
    ...
    */
    ...
    {
        return SERIALIZATION_MEMORY_BLOCK_ID;
    }

protected:
    virtual void serializeImpl(interface1::InputDataArchive  *arch) DAAL_C11_OVERRIDE
    {
        arch->set(_size);
        if(_size)
    ...
    virtual void deserializeImpl(interface1::OutputDataArchive *arch) DAAL_C11_OVERRIDE
    {
        size_t sz = 0;
        arch->set(sz);
        reserve(sz);
