...
#define DAAL_CHECK_ERRORS(cond, error, errors) \
if(!(cond))                                    \
{                                              \
...
#define DAAL_CHECK(cond, error) DAAL_CHECK_ERRORS(cond, error, this->_errors)


#define DAAL_CHECK_ERRORS_EX(cond, error, errors, detailType, detailValue) \
if(!(cond))                                                                \
{                                                                          \
    errors->add(services::Error::create(error, detailType, detailValue));  \
    return;                                                                \
}

#define DAAL_CHECK_EX(cond, error, detailType, detailValue) DAAL_CHECK_ERRORS_EX(cond, error, this->_errors, detailType, detailValue)
