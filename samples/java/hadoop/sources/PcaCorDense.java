...
/*
 ...
 //     method with data in dense format in the distributed processing mode
 ////////////////////////////////////////////////////////////////////////////////
 */
...
public class PcaCorDense extends Configured implements Tool {

    public static void main(String[] args) throws Exception {
        int res = ToolRunner.run(new Configuration(), new PcaCorDense(), args);
        System.exit(res);
    }
    ...
    public int run(String[] args) throws Exception {
        ...
        job.setMapperClass(PcaCorDenseStep1Mapper.class);
        job.setReducerClass(PcaCorDenseStep2Reducer.class);
        ...
        job.setJarByClass(PcaCorDense.class);
