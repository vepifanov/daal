...
public class CovarianceDense extends Configured implements Tool {

    public static void main(String[] args) throws Exception {
        int res = ToolRunner.run(new Configuration(), new CovarianceDense(), args);
        System.exit(res);
    }
