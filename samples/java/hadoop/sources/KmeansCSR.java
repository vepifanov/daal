...
/*
 //  Content:
 //     Java sample of sparse K-Means clustering in the distributed processing mode
 ////////////////////////////////////////////////////////////////////////////////
 */
...
public class KmeansCSR extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        FileOutputFormat.setOutputPath(initJob, new Path("/Hadoop/KmeansCSR/initResults"));

        initJob.setMapperClass(KmeansCSRInitStep1Mapper.class);
        initJob.setReducerClass(KmeansCSRInitStep2Reducer.class);
        ...
        initJob.setJarByClass(KmeansCSR.class);
        ...
        for(int i = 0; i < nIterations; i++) {
            ...
            if( i == nIterations - 1) {
                ...
                FileOutputFormat.setOutputPath(job, new Path("/Hadoop/KmeansCSR/ResultsIter" + i));
            }
            job.setMapperClass(KmeansCSRStep1Mapper.class);
            job.setReducerClass(KmeansCSRStep2Reducer.class);
