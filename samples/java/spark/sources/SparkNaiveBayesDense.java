/* file: SparkNaiveBayesDense.java */
/*******************************************************************************
...
public class SparkNaiveBayesDense {
    ...
    private static JavaRDD<TrainingPartialResult> trainLocal(JavaRDD<Tuple2<HomogenNumericTable, HomogenNumericTable>> trainDataRDD) {
        return trainDataRDD.map(new Function<Tuple2<HomogenNumericTable, HomogenNumericTable>, TrainingPartialResult>() {
            public TrainingPartialResult call(Tuple2<HomogenNumericTable, HomogenNumericTable> tup) {
    ...
    private static HomogenNumericTable testModel(DaalContext context, JavaRDD<Tuple2<HomogenNumericTable, HomogenNumericTable>> testData,
                                                 final Model model) {
