...
public class SparkKmeansInitCSR {
    ...
    public static KmeansInitResult initKmeansPlusPlus(JavaSparkContext sc, DaalContext context, JavaPairRDD<Integer, CSRNumericTable> dataRDD) throws IOException, ClassNotFoundException {
        ...
        InitDistributedStep3Master step3 = new InitDistributedStep3Master(context, Double.class, InitMethod.plusPlusCSR, nClusters);
    ...
    public static KmeansInitResult initKmeansParallelPlus(JavaSparkContext sc, DaalContext context, JavaPairRDD<Integer, CSRNumericTable> dataRDD) throws IOException, ClassNotFoundException {
        ...
        /* Create an algorithm object for the step 3 */
        InitDistributedStep3Master step3 = new InitDistributedStep3Master(context, Double.class, InitMethod.parallelPlusCSR, nClusters);

        /* Create an algorithm object for the step 5 */
        InitDistributedStep5Master step5 = new InitDistributedStep5Master(context, Double.class, InitMethod.parallelPlusCSR, nClusters);
    ...
    public static KmeansResult runKmeans(DaalContext context, JavaPairRDD<Integer, CSRNumericTable> dataRDD, NumericTable initCentroids) {
        initCentroids.pack();
    ...
    private static JavaRDD<NumericTable> initStep1Local(JavaPairRDD<Integer, CSRNumericTable> dataRDD,
                                                        final boolean isPlusPlus) {
        return dataRDD.map(new Function<Tuple2<Integer, CSRNumericTable>, NumericTable>() {
            public NumericTable call(Tuple2<Integer, CSRNumericTable> tup) {
                DaalContext localContext = new DaalContext();
                CSRNumericTable  dataTable = tup._2;
                dataTable.unpack(localContext);
                InitMethod method = (isPlusPlus == true) ? InitMethod.plusPlusCSR : InitMethod.parallelPlusCSR;
                ...
                NumericTable pNewCenters = initPres.get(InitPartialResultId.partialClusters);
    ...
    private static JavaPairRDD<Integer, Tuple2<DataCollection, NumericTable>> initStep2LocalFirst(final NumericTable step2Input,
                                                                                                  JavaPairRDD<Integer, CSRNumericTable> dataRDD,
                                                                                                  final boolean isPlusPlus) {
        return dataRDD.mapToPair(new PairFunction<Tuple2<Integer, CSRNumericTable>, Integer, Tuple2<DataCollection, NumericTable>>() {
            public Tuple2<Integer, Tuple2<DataCollection, NumericTable>> call(Tuple2<Integer, CSRNumericTable> tup) {
                DaalContext localContext = new DaalContext();
                InitMethod method = (isPlusPlus == true) ? InitMethod.plusPlusCSR : InitMethod.parallelPlusCSR;
    ...
    private static JavaPairRDD<Integer, Tuple2<DataCollection, NumericTable>> initStep2Local(JavaPairRDD<Integer, Tuple2<DataCollection, NumericTable>> localNodeData,
                                                                                             ...
                                                                                             final boolean isPlusPlus) {
        /* Cogroup three RDDs */
        JavaPairRDD<Integer, Tuple2<Iterable<CSRNumericTable>, Iterable<Tuple2<DataCollection, NumericTable>>> > groupedData = dataRDD.cogroup(localNodeData);

        return groupedData.mapToPair(new PairFunction<Tuple2<Integer, Tuple2<Iterable<CSRNumericTable>, Iterable<Tuple2<DataCollection, NumericTable>>>>, Integer, Tuple2<DataCollection, NumericTable>>() {
            public Tuple2<Integer, Tuple2<DataCollection, NumericTable>> call(Tuple2<Integer, Tuple2<Iterable<CSRNumericTable>, Iterable<Tuple2<DataCollection, NumericTable>>>> tup) {
                DaalContext localContext = new DaalContext();
                InitMethod method = (isPlusPlus == true) ? InitMethod.plusPlusCSR : InitMethod.parallelPlusCSR;
                final boolean isFirst = false;

                CSRNumericTable dataTable = tup._2._1().iterator().next();
    ...
    private static JavaRDD<NumericTable> initStep4Local(JavaPairRDD<Integer, Tuple2<DataCollection, NumericTable>> localNodeData,
                                                        ...
                                                        final boolean isPlusPlus) {
        /* Cogroup three RDDs */
        JavaPairRDD<Integer, Tuple3<Iterable<CSRNumericTable>, Iterable<Tuple2<DataCollection, NumericTable>>, Iterable<InitDistributedStep3MasterPlusPlusPartialResult>>> groupedData = dataRDD.cogroup(localNodeData, step3Pres);
        return groupedData.map(new Function<Tuple2<Integer, Tuple3<Iterable<CSRNumericTable>, Iterable<Tuple2<DataCollection, NumericTable>>, Iterable<InitDistributedStep3MasterPlusPlusPartialResult>>>, NumericTable>() {
                    public NumericTable call(Tuple2<Integer, Tuple3<Iterable<CSRNumericTable>, Iterable<Tuple2<DataCollection, NumericTable>>, Iterable<InitDistributedStep3MasterPlusPlusPartialResult>>> tup) {
                DaalContext localContext = new DaalContext();
                InitMethod method = (isPlusPlus == true) ? InitMethod.plusPlusCSR : InitMethod.parallelPlusCSR;
