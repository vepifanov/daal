...
public class SampleImplicitALSCSR {
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        DistributedHDFSDataSet ddTrain = new DistributedHDFSDataSet("/Spark/ImplicitALSCSR/data/ImplicitALSCSR_*",
                                                                    templateDataSource);
        DistributedHDFSDataSet ddTrainTransposed = new DistributedHDFSDataSet("/Spark/ImplicitALSCSR/data/ImplicitALSCSRTrans_*",
                                                                              templateDataSource );
        ...
        SparkImplicitALSCSR.TrainingResult trainedModel = SparkImplicitALSCSR.trainModel(sc, dataRDD, transposedDataRDD);
