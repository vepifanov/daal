...
void printNumericTable(NumericTable *dataTable, char *message = "",
...
void printNumericTable(const NumericTablePtr &dataTable, char *message = "",
                       size_t nPrintedRows = 0, size_t nPrintedCols = 0)
{
    printNumericTable(dataTable.get(), message, nPrintedRows, nPrintedCols);
}

void printPackedNumericTable(NumericTable *dataTable, size_t nFeatures, char *message = "")
{
    BlockDescriptor<double> block;
