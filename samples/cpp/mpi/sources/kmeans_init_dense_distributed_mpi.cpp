...
NumericTablePtr computeCentroids(int rankId, const NumericTablePtr& pData, const NumericTablePtr& initialCentroids)
{
    ...
    kmeans::Distributed<step1Local, double, kmeans::lloydDense> localAlgorithm(nClusters);
    ...
    if(isRoot)
    {
        ...
        kmeans::Distributed<step2Master, double, kmeans::lloydDense> masterAlgorithm(nClusters);
