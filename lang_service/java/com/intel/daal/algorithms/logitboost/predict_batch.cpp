...
#include <jni.h>/* Header for class com_intel_daal_algorithms_logitboost_prediction_PredictionBatch */

#include "daal.h"
#include "logitboost/prediction/JPredictionBatch.h"
...
/*
 * Class:     com_intel_daal_algorithms_logitboost_prediction_PredictionBatch
 * Method:    cInit
 * Signature:(IIJ)J
 */
...
{
    return jniBatch<logitboost::prediction::Method, Batch, defaultDense>::newObj(prec, method, nClasses);
}
