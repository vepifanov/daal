...
#include "covariance/JInitializationProcedure.h"

using namespace daal;
using namespace daal::algorithms;

/*
 * Class:     com_intel_daal_algorithms_covariance_InitializationProcedure
 * Method:    newJavaInitializationProcedure
 * Signature: ()J
 */
JNIEXPORT jlong JNICALL Java_com_intel_daal_algorithms_covariance_InitializationProcedure_cNewJavaInitializationProcedure
 ...
 * Signature: (J)J
 */
JNIEXPORT void JNICALL Java_com_intel_daal_algorithms_covariance_InitializationProcedure_cInitIfaceDispose
(JNIEnv *, jobject, jlong cInitIface)
{
    services::SharedPtr<covariance::PartialResultsInitIface> *ptr = (services::SharedPtr<covariance::PartialResultsInitIface> *) cInitIface;
    delete ptr;
}
