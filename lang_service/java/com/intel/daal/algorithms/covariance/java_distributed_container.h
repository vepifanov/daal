...
{
public:
    JavaDistributedContainer(JavaVM *_jvm, jobject _javaObject) : JavaCallback(_jvm, _javaObject), _initFlag(false), resultStorage(NULL), partialResultStorage(NULL)
    {};
...
protected:
    ...
    {
        const char *javaParameterClassName = "Lcom/intel/daal/algorithms/covariance/Parameter;";
        ...
        jfieldID parameterFieldID = env->GetFieldID(javaObjectClass, "parameter", "Lcom/intel/daal/algorithms/covariance/Parameter;");
