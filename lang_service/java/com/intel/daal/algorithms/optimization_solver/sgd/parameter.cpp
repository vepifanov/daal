 ...
 * Signature: (JJ)V
 */
JNIEXPORT void JNICALL Java_com_intel_daal_algorithms_optimization_1solver_sgd_ParameterMomentum_cSetBatchSize
(JNIEnv *, jobject, jlong parAddr, jlong batchSize)
{
    ((sgd::Parameter<sgd::momentum> *)parAddr)->batchSize = batchSize;
}
 ...
 * Signature: (J)J
 */
JNIEXPORT jlong JNICALL Java_com_intel_daal_algorithms_optimization_1solver_sgd_ParameterMomentum_cGetBatchSize
(JNIEnv *, jobject, jlong parAddr)
{
    return ((sgd::Parameter<sgd::momentum> *)parAddr)->batchSize;
}
