...
#include "low_order_moments/JInitializationProcedure.h"
...
/*
 * Class:     com_intel_daal_algorithms_low_order_moments_InitializationProcedure
 * Method:    cNewJavaInitializationProcedure
 * Signature: ()J
 */
JNIEXPORT jlong JNICALL Java_com_intel_daal_algorithms_low_1order_1moments_InitializationProcedure_cNewJavaInitializationProcedure
 ...
 * Signature: (J)J
 */
JNIEXPORT void JNICALL Java_com_intel_daal_algorithms_low_1order_1moments_InitializationProcedure_cInitIfaceDispose
(JNIEnv *, jobject, jlong cInitIface)
{
    services::SharedPtr<low_order_moments::PartialResultsInitIface> *ptr = (services::SharedPtr<low_order_moments::PartialResultsInitIface> *) cInitIface;
    delete ptr;
}
