...
#include "daal.h"
#include "low_order_moments/JBatchIface.h"
...
{
    /*
     * Class:     com_intel_daal_algorithms_low_order_moments_BatchIface
     * Method:    cSetResult
     * Signature: (JIIJ)V
     */
    JNIEXPORT void JNICALL Java_com_intel_daal_algorithms_low_1order_1moments_BatchIface_cSetResult
     ...
     * Signature: (JII)J
     */
    JNIEXPORT jlong JNICALL Java_com_intel_daal_algorithms_low_1order_1moments_BatchIface_cGetResult
     ...
     * Signature: ()J
     */
    JNIEXPORT jlong JNICALL Java_com_intel_daal_algorithms_low_1order_1moments_BatchIface_cInitBatchIface
     ...
     * Signature: (J)V
     */
    JNIEXPORT void JNICALL Java_com_intel_daal_algorithms_low_1order_1moments_BatchIface_cDispose
    (JNIEnv *env, jobject thisObj, jlong initAddr)
    {
        SharedPtr<BatchIface> *batch = (SharedPtr<BatchIface> *)initAddr;
        delete batch;
    }
}
