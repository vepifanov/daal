...
#include "implicit_als/training/JDistributedPartialResultStep3.h"
...
/*
 * Class:     com_intel_daal_algorithms_implicit_als_training_DistributedPartialResultStep3
 * Method:    cGetDistributedPartialResultStep3
 * Signature: (JII)J
 */
JNIEXPORT jlong JNICALL Java_com_intel_daal_algorithms_implicit_1als_training_DistributedPartialResultStep3_cGetDistributedPartialResultStep3
  (JNIEnv *env, jobject thisObj, jlong algAddr, jint prec, jint method)
{
    return jniDistributed<step3Local, implicit_als::training::Method, Distributed, fastCSR, defaultDense>::
