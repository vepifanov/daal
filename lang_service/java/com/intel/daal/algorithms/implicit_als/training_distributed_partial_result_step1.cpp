...
/*
 * Class:     com_intel_daal_algorithms_implicit_als_training_DistributedPartialResultStep1
 * Method:    cGetDistributedPartialResultStep1
 * Signature: (JII)J
 */
JNIEXPORT jlong JNICALL Java_com_intel_daal_algorithms_implicit_1als_training_DistributedPartialResultStep1_cGetDistributedPartialResultStep1
  (JNIEnv *env, jobject thisObj, jlong algAddr, jint prec, jint method)
{
    return jniDistributed<step1Local, implicit_als::training::Method, Distributed, fastCSR, defaultDense>::
...
{
    return jniArgument<implicit_als::training::DistributedPartialResultStep1>::
...
{
    jniArgument<implicit_als::training::DistributedPartialResultStep1>::
