  ...
  (JNIEnv * env, jobject thisObject, jlong cObject)
{
    ...
    if(tag == data_feature_utils::getIndexNumType<float>() + SERIALIZATION_HOMOGEN_TENSOR_ID ||
       tag == data_feature_utils::getIndexNumType<float>() + SERIALIZATION_MKL_TENSOR_ID)
    {
        return (jint)(data_feature_utils::getIndexNumType<float>());
    }
    if(tag == data_feature_utils::getIndexNumType<double>() + SERIALIZATION_HOMOGEN_TENSOR_ID ||
       tag == data_feature_utils::getIndexNumType<double>() + SERIALIZATION_MKL_TENSOR_ID)
    {
        return (jint)(data_feature_utils::getIndexNumType<double>());
    }
    if(tag == data_feature_utils::getIndexNumType<int>() + SERIALIZATION_HOMOGEN_TENSOR_ID)
    {
        return (jint)(data_feature_utils::getIndexNumType<int>());
    }
    if(tag == data_feature_utils::getIndexNumType<long>() + SERIALIZATION_HOMOGEN_TENSOR_ID)
    {
        return (jint)(data_feature_utils::getIndexNumType<long>());
    }
    if(tag == data_feature_utils::getIndexNumType<size_t>() + SERIALIZATION_HOMOGEN_TENSOR_ID)
    {
        return (jint)(data_feature_utils::getIndexNumType<size_t>());
    }
