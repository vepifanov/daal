...
abstract public class NumericTable extends SerializableBase implements NumericTableDenseIface {
    ...
    static public class StorageLayout implements Serializable {
    ...
    static public class AllocationFlag {
        ...
        public static final AllocationFlag NotAllocate = new AllocationFlag(
            _notAllocate); /** @DAAL_DEPRECATED_USE{ @ref com.intel.daal.data_management.data.NumericTable.AllocationFlag.DoNotAllocate "DoNotAllocate" }*/
     ...
     */
    public MemoryStatus getDataMemoryStatus() {
    ...
    public int getIntValue(long column, long row) {
        return tableImpl.getIntValue(column, row);
    }
    ...
    public float getFloatValue(long column, long row) {
        return tableImpl.getFloatValue(column, row);
    }
    ...
    public double getDoubleValue(long column, long row) {
        return tableImpl.getDoubleValue(column, row);
    }
