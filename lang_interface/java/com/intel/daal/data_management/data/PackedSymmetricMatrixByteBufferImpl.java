/* file: PackedSymmetricMatrixByteBufferImpl.java */
/*******************************************************************************
...
class PackedSymmetricMatrixByteBufferImpl extends PackedSymmetricMatrixImpl {
    ...
    /** @copydoc PackedSymmetricMatrix::PackedSymmetricMatrix(DaalContext,long) */
    public PackedSymmetricMatrixByteBufferImpl(DaalContext context, long cTable) {
        super(context);
        cObject = cTable;
    ...
    public PackedSymmetricMatrixByteBufferImpl(DaalContext context, Class<? extends Number> cls, long nDim, NumericTable.StorageLayout layout) {
        super(context);
        initPackedSymmetricMatrix(context, cls, nDim, NumericTable.AllocationFlag.DoNotAllocate, layout);
    }

    public PackedSymmetricMatrixByteBufferImpl(DaalContext context, Class<? extends Number> cls, long nDim, NumericTable.StorageLayout layout,
            NumericTable.AllocationFlag allocFlag) {
        super(context);
        initPackedSymmetricMatrix(context, cls, nDim, allocFlag, layout);
    }
    ...
    private void initPackedSymmetricMatrix(DaalContext context, Class<? extends Number> cls, long nDim,
    ...
    /* Creates C++ PackedSymmetricMatrix object */
    ...
    /* Gets index type of the C++ PackedSymmetricMatrix object */
