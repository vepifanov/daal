 ...
 */
/**
 * @brief Contains classes to check the quality of the model trained with the BrownBoost algorithm
 */
...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__BROWNBOOST__QUALITY_METRIC_SET__QUALITYMETRICSETBATCH"></a>
 * @brief Class that represents a quality metric set to check the model trained with the BrownBoost algorithm
 *
 * @par Enumerations
