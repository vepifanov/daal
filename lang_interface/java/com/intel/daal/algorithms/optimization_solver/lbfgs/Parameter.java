...
public class Parameter extends com.intel.daal.algorithms.optimization_solver.iterative_solver.Parameter {
     ...
     * @param context Context to manage the parameters of the LBFGS algorithm
     */
    ...
    /**
     * Sets the memory parameter of the LBFGS algorithm. Which is the maximum number of correction pairs
     * that define the approximation of inverse Hessian matrix
     * @param m The memory parameter of the LBFGS algorithm
     */
    ...
    /**
     * Gets the memory parameter of the LBFGS algorithm. Which is the maximum number of correction pairs
     * that define the approximation of inverse Hessian matrix
     * @return The memory parameter of the LBFGS algorithm
     */
    public long getM() {
