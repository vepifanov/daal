/* file: InitDistributedStep3Master.java */
/*******************************************************************************
...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__KMEANS__INIT__INITDISTRIBUTEDSTEP3MASTER"></a>
 ...
 *      - InitDistributedStep3MasterPlusPlusInput class
 *      - InitDistributedStep3MasterPlusPlusPartialResult class
 *      - InitParameter class
 */
public class InitDistributedStep3Master extends AnalysisDistributed {
    public InitDistributedStep3MasterPlusPlusInput            input;         /*!< %Input data */
    ...
    protected InitDistributedStep3MasterPlusPlusPartialResult partialResult; /*!< Partial result of the initialization algorithm */
     ...
     */
    public InitDistributedStep3Master(DaalContext context, InitDistributedStep3Master other) {
        super(context);
        this.method = other.method;
        prec = other.prec;

        this.cObject = cClone(other.cObject, prec.getValue(), this.method.getValue());
        input = new InitDistributedStep3MasterPlusPlusInput(getContext(), cGetInput(cObject, prec.getValue(), method.getValue()));
     ...
     */
    public InitDistributedStep3Master(DaalContext context, Class<? extends Number> cls, InitMethod method, long nClusters) {
        super(context);
        this.method = method;
     ...
     */
    @Override
    public InitDistributedStep3MasterPlusPlusPartialResult compute() {
        super.compute();
        partialResult = new InitDistributedStep3MasterPlusPlusPartialResult(getContext(), cGetPartialResult(cObject, prec.getValue(), method.getValue()));
     ...
     */
    public void setPartialResult(InitDistributedStep3MasterPlusPlusPartialResult partialResult, boolean initFlag) {
     ...
     * @param partialResult         Structure to store partial results of computing initial centroids for the K-Means algorithm
     */
    public void setPartialResult(InitDistributedStep3MasterPlusPlusPartialResult partialResult) {
     ...
     */
    @Override
    public InitDistributedStep3Master clone(DaalContext context) {
        return new InitDistributedStep3Master(context, this);
    }
