/* file: InitDistributedStep5Master.java */
/*******************************************************************************
...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__KMEANS__INIT__INITDISTRIBUTEDSTEP5MASTER"></a>
 ...
 *      - InitDistributedStep5MasterPlusPlusInput class
 *      - InitParameter class
 *      - InitDistributedStep5MasterPlusPlusPartialResult class
 *      - InitResult class
 */
public class InitDistributedStep5Master extends AnalysisDistributed {
    public InitDistributedStep5MasterPlusPlusInput            input;         /*!< Input data */
    ...
    protected InitDistributedStep5MasterPlusPlusPartialResult partialResult; /*!< Partial result of the initialization algorithm */
     ...
     */
    public InitDistributedStep5Master(DaalContext context, InitDistributedStep5Master other) {
        super(context);
        this.method = other.method;
        prec = other.prec;

        this.cObject = cClone(other.cObject, prec.getValue(), this.method.getValue());
        input = new InitDistributedStep5MasterPlusPlusInput(getContext(), cGetInput(cObject, prec.getValue(), method.getValue()));
     ...
     */
    public InitDistributedStep5Master(DaalContext context, Class<? extends Number> cls, InitMethod method, long nClusters) {
        super(context);
        this.method = method;
        ...
        if (this.method != InitMethod.parallelPlusDense && this.method != InitMethod.parallelPlusCSR ) {
     ...
     */
    @Override
    public InitDistributedStep5MasterPlusPlusPartialResult compute() {
        super.compute();
        partialResult = new InitDistributedStep5MasterPlusPlusPartialResult(getContext(), cGetPartialResult(cObject, prec.getValue(), method.getValue()));
     ...
     */
    public void setPartialResult(InitDistributedStep5MasterPlusPlusPartialResult partialResult, boolean initFlag) {
     ...
     * @param partialResult         Structure to store partial results of computing initial centroids for the K-Means algorithm
     */
    public void setPartialResult(InitDistributedStep5MasterPlusPlusPartialResult partialResult) {
     ...
     */
    @Override
    public InitDistributedStep5Master clone(DaalContext context) {
        return new InitDistributedStep5Master(context, this);
    }
