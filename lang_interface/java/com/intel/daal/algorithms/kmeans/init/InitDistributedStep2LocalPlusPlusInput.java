/* file: InitDistributedStep2LocalPlusPlusInput.java */
/*******************************************************************************
...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__KMEANS__INIT__INITDISTRIBUTEDSTEP2LOCALPLUSPLUSINPUT"></a>
 ...
 *        with plusPlus and parallelPlus methods only on the 2nd step on a local node.
 */
public final class InitDistributedStep2LocalPlusPlusInput extends com.intel.daal.algorithms.kmeans.init.InitInput {
    /** @private */
    static {
        System.loadLibrary("JavaAPI");
    }

    public InitDistributedStep2LocalPlusPlusInput(DaalContext context, long cObject) {
    ...
    public void set(InitDistributedStep2LocalPlusPlusInputId id, NumericTable val) {
        if (id == InitDistributedStep2LocalPlusPlusInputId.inputOfStep2) {
     ...
     */
    public NumericTable get(InitDistributedStep2LocalPlusPlusInputId id) {
        if (id == InitDistributedStep2LocalPlusPlusInputId.inputOfStep2) {
