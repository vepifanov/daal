...
public class Model extends com.intel.daal.algorithms.classifier.Model {
    ...
    public NumericTable getLogP() {
        return (NumericTable)Factory.instance().createObject(getContext(), cGetLogP(this.getCObject()));
    }
    ...
    public NumericTable getLogTheta() {
        return (NumericTable)Factory.instance().createObject(getContext(), cGetLogTheta(this.getCObject()));
    }
