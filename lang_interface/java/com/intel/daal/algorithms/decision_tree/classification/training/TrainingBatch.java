 ...
 */
/**
 * @brief Contains classes for training decision tree classification algorithm
 */
...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__DECISION_TREE__CLASSIFICATION__TRAINING__TRAININGBATCH"></a>
 * @brief Trains a model of the decision tree classification algorithm in the batch processing mode
 * <!-- \n<a href="DAAL-REF-DECISION_TREE__CLASSIFICATION-ALGORITHM">decision tree classification algorithm description and usage models</a> -->
 *
 * \par References
...
public class TrainingBatch extends com.intel.daal.algorithms.TrainingBatch {
    ...
    public TrainingInput  input;   /*!< %Input for the algorithm */
    ...
    /**
     * Constructs the decision tree classification training algorithm by copying input objects and parameters
     * of another decision tree classification training algorithm
     * @param context   Context to manage decision tree classification training
    ...
    /**
     * Constructs the decision tree classification training algorithm
     * @param context   Context to manage decision tree classification training
     * @param cls       Data type to use in intermediate computations for decision tree classification training,
     *                  Double.class or Float.class
     * @param method    decision tree classification training method, @ref TrainingMethod
    ...
    /**
     * Trains a model of the decision tree classification algorithm
     * @return Structure that contains results of the decision tree classification training algorithm
     */
    @Override
    ...
    /**
     * Returns the newly allocated decision tree classification training algorithm with a copy of input objects
     * and parameters of this decision tree classification training algorithm
     * @param context   Context to manage decision tree classification training
     *
