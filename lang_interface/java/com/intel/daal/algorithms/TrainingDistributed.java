 ...
 *  @brief Provides methods to train models that depend on the data provided in distributed mode.
 *         For example, these methods enable training the linear regression model.
 *         Classes that implement specific algorithms of model training in distributed mode are derived classes of the TrainingDistributed class.
