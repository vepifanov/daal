...
public class TrainingDistributedStep1Local extends TrainingDistributed {
    ...
    /**
     * Computes a partial result of ridge regression model-based training in the first step of the distributed processing mode
     * @return Partial result of ridge regression model-based training in the first step of the distributed processing mode
     */
    @Override
    ...
    /**
     * Computes the result of the ridge regression model-based training in the first step of the distributed processing mode
     * @return Result of ridge regression model-based training in the first step of the distributed processing mode
     */
    @Override
