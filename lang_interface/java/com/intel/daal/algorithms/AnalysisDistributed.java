 ...
 * @brief Provides methods for execution of operations over data, such as computation of Summary Statistics estimates in distributed processing mode.
 *        Classes that implement specific algorithms of the data analysis in distributed processing mode are derived classes of the AnalysisDistributed class.
...
public abstract class AnalysisDistributed extends Algorithm implements Disposable {
     ...
     * @param context  Context to manage the algorithm in the distributed processing mode
     */
