/* file: MaximumPooling2dBackwardBatch.java */
/*******************************************************************************
...
/**
 * @defgroup maximum_pooling2d_backward_batch Batch
...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__NEURAL_NETWORKS__LAYERS__MAXIMUM_POOLING2D__MAXIMUMPOOLING2DBACKWARDBATCH"></a>
 ...
 */
public class MaximumPooling2dBackwardBatch extends com.intel.daal.algorithms.neural_networks.layers.BackwardLayer {
    public  MaximumPooling2dBackwardInput input;     /*!< %Input data */
     ...
     */
    public MaximumPooling2dBackwardBatch(DaalContext context, MaximumPooling2dBackwardBatch other) {
        super(context);
        this.method = other.method;
        prec = other.prec;

        this.cObject = cClone(other.cObject, prec.getValue(), method.getValue());
        input = new MaximumPooling2dBackwardInput(context, cGetInput(cObject, prec.getValue(), method.getValue()));
     ...
     */
    public MaximumPooling2dBackwardBatch(DaalContext context, Class<? extends Number> cls, MaximumPooling2dMethod method, long nDim) {
        super(context);
    ...
    MaximumPooling2dBackwardBatch(DaalContext context, Class<? extends Number> cls, MaximumPooling2dMethod method, long cObject, long nDim) {
        super(context);
     ...
     */
    @Override
    public MaximumPooling2dBackwardResult compute() {
        super.compute();
        MaximumPooling2dBackwardResult result = new MaximumPooling2dBackwardResult(getContext(), cGetResult(cObject, prec.getValue(), method.getValue()));
        return result;
    }
     ...
     */
    public void setResult(MaximumPooling2dBackwardResult result) {
     ...
     */
    @Override
    public MaximumPooling2dBackwardResult getLayerResult() {
        return new MaximumPooling2dBackwardResult(getContext(), cGetResult(cObject, prec.getValue(), method.getValue()));
    }
     ...
     */
    @Override
    public MaximumPooling2dBackwardInput getLayerInput() {
        return input;
    }
     ...
     */
    @Override
    public MaximumPooling2dBackwardBatch clone(DaalContext context) {
        return new MaximumPooling2dBackwardBatch(context, this);
    }
