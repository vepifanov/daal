...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__NEURAL_NETWORKS__LAYERS__LOGISTIC__LOGISTICLAYERDATAID"></a>
...
public final class LogisticLayerDataId {
     ...
     */
    public LogisticLayerDataId(int value) {
        _value = value;
    }
    ...
    public static final LogisticLayerDataId auxValue = new LogisticLayerDataId(auxValueId); /*!< Value computed at the forward stage of the layer */
}
/** @} */
