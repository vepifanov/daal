/* file: EltwiseSumForwardInputId.java */
/*******************************************************************************
...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__NEURAL_NETWORKS__LAYERS__ELTWISE_SUM__ELTWISESUMFORWARDINPUTID"></a>
...
public final class EltwiseSumForwardInputId {
     ...
     */
    public EltwiseSumForwardInputId(int value) {
        _value = value;
    }
    ...
    public static final EltwiseSumForwardInputId coefficients =
        new EltwiseSumForwardInputId(cGetCoefficientsId());
