...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__NEURAL_NETWORKS__INITIALIZERS__XAVIER__XAVIERMETHOD"></a>
 * @brief Available methods for the Xavier initializer
 */
public final class XavierMethod {
    /** @private */
    static {
    ...
    public static final XavierMethod defaultDense = new XavierMethod(defaultDenseId); /*!< Default: performance-oriented method */
}
/** @} */
