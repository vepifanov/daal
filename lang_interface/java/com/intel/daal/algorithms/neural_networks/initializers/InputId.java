...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__NEURAL_NETWORKS__INITIALIZERS__INPUTID"></a>
 * @brief Available identifiers of input objects for neural network weights and biases initializer
 */
public final class InputId {
    ...
    public static final InputId data = new InputId(dataId); /*!< Input data */
}
/** @} */
