...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__DISTRIBUTIONS__RESULTID"></a>
 * @brief Available identifiers of results for the distributions
 */
public final class ResultId {
    ...
    private static final int randomNumbersId = 0;
