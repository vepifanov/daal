 ...
 * @brief Results obtained with the compute() method of the hyperbolic tangent function in the batch processing mode
 */
public final class Result extends com.intel.daal.algorithms.Result {
    ...
    /**
     * Constructs the result of the hyperbolic tangent function
     * @param context   Context to manage the result of the hyperbolic tangent function
     */
    ...
    /**
     * Returns the result of hyperbolic tangent function
    ...
    /**
     * Sets the final result of the hyperbolic tangent function
     * @param id   Identifier of the result
