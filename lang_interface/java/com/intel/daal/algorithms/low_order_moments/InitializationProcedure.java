...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__LOW_ORDER_MOMENTS__INITIALIZATIONPROCEDURE"></a>
...
public class InitializationProcedure extends InitializationProcedureIface {
    ...
    public void initialize(Input input, PartialResult partialResult) {
        ...
        if(nRowsTable == null || partialMinimumTable == null || partialMaximumTable  == null ||
            partialSumTable == null || partialSumSquaresTable == null || partialSumSquaresCenteredTable == null) {
