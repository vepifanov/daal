...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__LOGITBOOST__PREDICTION__PREDICTIONINPUT"></a>
 * @brief  %Input objects for the LogitBoost algorithm
 */
public class PredictionInput extends com.intel.daal.algorithms.classifier.prediction.PredictionInput {
    ...
    /**
     * Returns the Model input object for the LogitBoost model-based prediction algorithm
