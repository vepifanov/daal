 ...
 * @brief Results obtained with the compute() method of the RBF algorithm in the batch processing mode
 */
public class Result extends com.intel.daal.algorithms.Result {
    ...
    /**
     * Returns the result of the RBF algorithm
    ...
    /**
    * Sets the result of the RBF algorithm
    * @param id    Identifier of the result
