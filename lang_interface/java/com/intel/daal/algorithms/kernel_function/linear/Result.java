...
public class Result extends com.intel.daal.algorithms.Result {
    ...
    /**
     * Constructs the result of the linear kernel function algorithm in the batch processing mode
     * @param context   Context to manage the result of the linear kernel function algorithm in the batch processing mode
     */
