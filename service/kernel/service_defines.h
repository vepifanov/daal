...
#define IMPLEMENT_SERIALIZABLE_TAG1T(Class,T1,Tag) \
    template<> int Class<T1>::serializationTag() { return data_feature_utils::getIndexNumType<T1>() + Tag; } \
...
#define IMPLEMENT_SERIALIZABLE_TAG2T(Class,T1,T2,Tag) \
    template<> int Class<T1,T2>::serializationTag() { return data_feature_utils::getIndexNumType<T2>() + Tag; } \
