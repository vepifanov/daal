/* file: sgd_moment_dense_batch.cpp */
/*******************************************************************************
...
/**
 * <a name="DAAL-EXAMPLE-CPP-SGD_MOMENT_DENSE_BATCH"></a>
 * \example sgd_moment_dense_batch.cpp
 */
...
int main(int argc, char *argv[])
{
    ...
    optimization_solver::sgd::Batch<double, optimization_solver::sgd::momentum> sgdMomentumAlgorithm(mseObjectiveFunction);
    ...
    sgdMomentumAlgorithm.input.set(optimization_solver::iterative_solver::inputArgument,
                                   NumericTablePtr(new HomogenNumericTable<double>(initialPoint, 1, nFeatures + 1)));
