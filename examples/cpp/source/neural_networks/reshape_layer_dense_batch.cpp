...
int main()
{
    ...
    services::SharedPtr<reshape::forward::Result> forwardResult = reshapeLayerForward.getResult();
    ...
    services::SharedPtr<backward::Result> backwardResult = reshapeLayerBackward.getResult();
