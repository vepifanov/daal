...
int main()
{
    ...
    services::SharedPtr<loss::logistic_cross::forward::Result> forwardResult = logisticCrossEntropyLayerForward.getResult();
    ...
    services::SharedPtr<backward::Result> backwardResult = logisticCrossEntropyLayerBackward.getResult();
