...
int main(int argc, char *argv[])
{
    ...
    SharedPtr<transposed_conv2d::forward::Result> forwardResult = transposedConv2dLayerForward.getResult();
    ...
    SharedPtr<backward::Result> backwardResult = transposedConv2dLayerBackward.getResult();
