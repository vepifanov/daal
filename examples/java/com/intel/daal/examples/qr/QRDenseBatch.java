...
class QRDenseBatch {
    ...
    public static void main(String[] args) throws java.io.FileNotFoundException, java.io.IOException {
        ...
        Batch qrAlgorithm = new Batch(context, Double.class, Method.defaultDense);
        ...
        /* Print the results */
        Service.printNumericTable("Input matrix (10 first vectors):", input, 10);
        Service.printNumericTable("Orthogonal matrix Q (10 first vectors):", matrixQ, 10);
