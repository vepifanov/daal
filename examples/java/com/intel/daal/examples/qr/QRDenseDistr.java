...
class QRDenseDistr {
    ...
    static void computeStep1Local(int block) {
        ...
        qrStep1Local = new DistributedStep1Local(context, Double.class, Method.defaultDense);
    ...
    static void computeStep2Master() {
        ...
        qrStep2Master = new DistributedStep2Master(context, Double.class, Method.defaultDense);
        for (int iNode = 0; iNode < nNodes; iNode++) {
    ...
    private static void computeStep3Local(int block) {
        ...
        /* Create an algorithm to compute QR decomposition on the master node */
        qrStep3Local = new DistributedStep3Local(context, Double.class, Method.defaultDense);
    ...
    private static void printResults() {
        Service.printNumericTable("Orthogonal matrix Q (10 first vectors):", Qi[0], 10);
