...
class LowOrderMomsDenseOnline {
    ...
    public static void main(String[] args) throws java.io.FileNotFoundException, java.io.IOException {
        ...
        /* Create initialization procedure for setting parameters of the low order moments algorithm */
        LowOrderMomsUserInitialization initializationProcedure = new LowOrderMomsUserInitialization(context, (int)input.getNumberOfColumns());
