...
class OutDetectUniDenseBatch {
    ...
    public static void main(String[] args) throws java.io.FileNotFoundException, java.io.IOException {
        ...
        /* Create initialization procedure for setting parameters of the univariate outlier detection algorithm */
        OutDetectUserInitialization initializationProcedure = new OutDetectUserInitialization(context, (int)data.getNumberOfColumns());

        /* Set initialization procedure to the algorithm */
        alg.parameter.setInitializationProcedure(initializationProcedure);
