...
class KDTreeKNNDenseBatch {
    ...
    private static void trainModel() {
        ...
        TrainingBatch kNearestNeighborsTrain = new TrainingBatch(context, Double.class, TrainingMethod.defaultDense);
    ...
    private static void testModel() {
        ...
        PredictionBatch kNearestNeighborsPredict = new PredictionBatch(context, Double.class,
