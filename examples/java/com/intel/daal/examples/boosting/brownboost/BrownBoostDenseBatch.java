/* file: BrownBoostDenseBatch.java */
/*******************************************************************************
...
/*
 //  Content:
 //     Java example of BrownBoost classification
 ////////////////////////////////////////////////////////////////////////////////
 */
...
package com.intel.daal.examples.boosting.brownboost;

import com.intel.daal.algorithms.brownboost.Model;
import com.intel.daal.algorithms.brownboost.prediction.*;
import com.intel.daal.algorithms.brownboost.training.*;
...
class BrownBoostDenseBatch {
    /* Input data set parameters */
    private static final String trainDataset = "../data/batch/brownboost_train.csv";

    private static final String testDataset  = "../data/batch/brownboost_test.csv";
