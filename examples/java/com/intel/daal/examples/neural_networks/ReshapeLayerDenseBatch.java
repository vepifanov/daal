...
class ReshapeLayerDenseBatch {
    ...
    public static void main(String[] args) throws java.io.FileNotFoundException, java.io.IOException {
        ...
        ReshapeForwardBatch reshapeLayerForward = new ReshapeForwardBatch(context, Double.class, ReshapeMethod.defaultDense);
        ...
        ReshapeBackwardBatch reshapeLayerBackward = new ReshapeBackwardBatch(context, Double.class, ReshapeMethod.defaultDense);
