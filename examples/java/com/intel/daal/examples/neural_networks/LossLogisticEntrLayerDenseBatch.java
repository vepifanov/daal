...
class LossLogisticEntrLayerDenseBatch {
    ...
    public static void main(String[] args) throws java.io.FileNotFoundException, java.io.IOException {
        ...
        LogisticCrossForwardBatch forwardLayer = new LogisticCrossForwardBatch(context, Double.class, LogisticCrossMethod.defaultDense);
        ...
        LogisticCrossBackwardBatch backwardLayer = new LogisticCrossBackwardBatch(context, Double.class, LogisticCrossMethod.defaultDense);
