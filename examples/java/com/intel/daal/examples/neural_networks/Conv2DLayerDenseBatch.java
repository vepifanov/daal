...
class Conv2DLayerDenseBatch {
    ...
    public static void main(String[] args) throws java.io.FileNotFoundException, java.io.IOException {
        ...
        Convolution2dForwardBatch convolution2DLayerForward = new Convolution2dForwardBatch(context, Double.class, Convolution2dMethod.defaultDense);
        ...
        Convolution2dBackwardBatch convolution2DLayerBackward = new Convolution2dBackwardBatch(context, Double.class, Convolution2dMethod.defaultDense);
