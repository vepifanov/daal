...
class ConcatLayerDenseBatch {
    ...
    public static void main(String[] args) throws java.io.FileNotFoundException, java.io.IOException {
        ...
        ConcatForwardBatch forwardLayer = new ConcatForwardBatch(context, Double.class, ConcatMethod.defaultDense);
        ...
        ConcatBackwardBatch backwardLayer = new ConcatBackwardBatch(context, Double.class, ConcatMethod.defaultDense);
        ...
        Service.printNumericTable("auxInputDimension", forwardResult.get(ConcatLayerDataId.auxInputDimensions), 5, 0);
