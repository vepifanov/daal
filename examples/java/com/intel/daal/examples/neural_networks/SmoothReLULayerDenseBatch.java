...
class SmoothReLULayerDenseBatch {
    ...
    public static void main(String[] args) throws java.io.FileNotFoundException, java.io.IOException {
        ...
        SmoothreluForwardBatch smoothreluLayerForward = new SmoothreluForwardBatch(context, Double.class, SmoothreluMethod.defaultDense);
        ...
        Service.printTensor("Smooth Relu layer result (first 5 rows):", forwardResult.get(ForwardResultId.value), 5, 0);
        ...
        SmoothreluBackwardBatch smoothreluLayerBackward = new SmoothreluBackwardBatch(context, Double.class, SmoothreluMethod.defaultDense);
        ...
        Service.printTensor("Smooth Relu layer backpropagation result (first 5 rows):", backwardResult.get(BackwardResultId.gradient), 5, 0);
