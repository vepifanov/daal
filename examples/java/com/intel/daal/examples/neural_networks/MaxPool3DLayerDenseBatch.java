...
class MaxPool3DLayerDenseBatch {
    ...
    public static void main(String[] args) throws java.io.FileNotFoundException, java.io.IOException {
        ...
        MaximumPooling3dForwardBatch maximumPooling3DLayerForward = new MaximumPooling3dForwardBatch(context, Double.class, MaximumPooling3dMethod.defaultDense, nDim);
        ...
        MaximumPooling3dBackwardBatch maximumPooling3DLayerBackward = new MaximumPooling3dBackwardBatch(context, Double.class, MaximumPooling3dMethod.defaultDense, nDim);
