...
class SplitLayerDenseBatch {
    ...
    public static void main(String[] args) throws java.io.FileNotFoundException, java.io.IOException {
        ...
        SplitForwardBatch forwardLayer = new SplitForwardBatch(context, Double.class, SplitMethod.defaultDense);
        ...
        SplitBackwardBatch backwardLayer = new SplitBackwardBatch(context, Double.class, SplitMethod.defaultDense);
