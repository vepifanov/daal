...
class DropoutLayerDenseBatch {
    ...
    public static void main(String[] args) throws java.io.FileNotFoundException, java.io.IOException {
        ...
        DropoutForwardBatch forwardLayer = new DropoutForwardBatch(context, Double.class, DropoutMethod.defaultDense);
        ...
        DropoutBackwardBatch backwardLayer = new DropoutBackwardBatch(context, Double.class, DropoutMethod.defaultDense);
