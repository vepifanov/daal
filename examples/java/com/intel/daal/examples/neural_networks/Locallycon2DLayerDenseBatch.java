...
class Locallycon2DLayerDenseBatch {
    ...
    public static void main(String[] args) throws java.io.FileNotFoundException, java.io.IOException {
        ...
        LocallyConnected2dForwardBatch locallyconnected2DLayerForward = new LocallyConnected2dForwardBatch(context, Double.class, LocallyConnected2dMethod.defaultDense);
        ...
        Service.printTensor("Forward two-dimensional locally connected layer result (first 5 rows):", forwardResult.get(ForwardResultId.value), 5, 0);
        Service.printTensor("Two-dimensional locally connected layer weights (first 5 rows):", forwardResult.get(LocallyConnected2dLayerDataId.auxWeights), 5, 0);
        ...
        LocallyConnected2dBackwardBatch locallyconnected2DLayerBackward = new LocallyConnected2dBackwardBatch(context, Double.class, LocallyConnected2dMethod.defaultDense);
        ...
        Service.printTensor("Backward 2D locally connected layer result (first 5 rows):", backwardResult.get(BackwardResultId.gradient), 5, 0);
