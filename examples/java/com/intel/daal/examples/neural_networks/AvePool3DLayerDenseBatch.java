...
class AvePool3DLayerDenseBatch {
    ...
    public static void main(String[] args) throws java.io.FileNotFoundException, java.io.IOException {
        ...
        AveragePooling3dForwardBatch averagePooling3DLayerForward = new AveragePooling3dForwardBatch(context, Double.class, AveragePooling3dMethod.defaultDense, nDim);
        ...
        AveragePooling3dBackwardBatch averagePooling3DLayerBackward = new AveragePooling3dBackwardBatch(context, Double.class, AveragePooling3dMethod.defaultDense, nDim);
