...
class MaxPool1DLayerDenseBatch {
    ...
    public static void main(String[] args) throws java.io.FileNotFoundException, java.io.IOException {
        ...
        MaximumPooling1dForwardBatch maximumPooling1DLayerForward = new MaximumPooling1dForwardBatch(context, Double.class, MaximumPooling1dMethod.defaultDense, nDim);
        ...
        MaximumPooling1dBackwardBatch maximumPooling1DLayerBackward = new MaximumPooling1dBackwardBatch(context, Double.class, MaximumPooling1dMethod.defaultDense, nDim);
