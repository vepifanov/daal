...
class SoftmaxLayerDenseBatch {
    ...
    public static void main(String[] args) throws java.io.FileNotFoundException, java.io.IOException {
        ...
        SoftmaxForwardBatch softmaxLayerForward = new SoftmaxForwardBatch(context, Double.class, SoftmaxMethod.defaultDense);
        ...
        SoftmaxBackwardBatch softmaxLayerBackward = new SoftmaxBackwardBatch(context, Double.class, SoftmaxMethod.defaultDense);
