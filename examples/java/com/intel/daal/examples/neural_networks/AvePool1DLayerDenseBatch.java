...
class AvePool1DLayerDenseBatch {
    ...
    public static void main(String[] args) throws java.io.FileNotFoundException, java.io.IOException {
        ...
        Service.printTensor("Forward one-dimensional pooling input (first 10 rows):", data, 10, 0);

        /* Create an algorithm to compute forward one-dimensional pooling layer results using average method */
        AveragePooling1dForwardBatch averagePooling1DLayerForward = new AveragePooling1dForwardBatch(context, Double.class, AveragePooling1dMethod.defaultDense, nDim);
        ...
        AveragePooling1dBackwardBatch averagePooling1DLayerBackward = new AveragePooling1dBackwardBatch(context, Double.class, AveragePooling1dMethod.defaultDense, nDim);
