...
class AbsLayerDenseBatch {
    ...
    public static void main(String[] args) throws java.io.FileNotFoundException, java.io.IOException {
        ...
        AbsForwardBatch absLayerForward = new AbsForwardBatch(context, Double.class, AbsMethod.defaultDense);
        ...
        AbsBackwardBatch absLayerBackward = new AbsBackwardBatch(context, Double.class, AbsMethod.defaultDense);
