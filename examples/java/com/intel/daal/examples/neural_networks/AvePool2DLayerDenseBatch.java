...
class AvePool2DLayerDenseBatch {
    ...
    public static void main(String[] args) throws java.io.FileNotFoundException, java.io.IOException {
        ...
        AveragePooling2dForwardBatch averagePooling2DLayerForward = new AveragePooling2dForwardBatch(context, Double.class, AveragePooling2dMethod.defaultDense, nDim);
        ...
        AveragePooling2dBackwardBatch averagePooling2DLayerBackward = new AveragePooling2dBackwardBatch(context, Double.class, AveragePooling2dMethod.defaultDense, nDim);
