...
class PReLULayerDenseBatch {
    ...
    public static void main(String[] args) throws java.io.FileNotFoundException, java.io.IOException {
        ...
        PreluForwardBatch preluLayerForward = new PreluForwardBatch(context, Double.class, PreluMethod.defaultDense);
        ...
        PreluBackwardBatch preluLayerBackward = new PreluBackwardBatch(context, Double.class, PreluMethod.defaultDense);
