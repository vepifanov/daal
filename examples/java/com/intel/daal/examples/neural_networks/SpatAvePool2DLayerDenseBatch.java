...
class SpatAvePool2DLayerDenseBatch {
    ...
    public static void main(String[] args) throws java.io.FileNotFoundException, java.io.IOException {
        ...
        SpatialAveragePooling2dForwardBatch spatialAvePooling2DLayerForward = new SpatialAveragePooling2dForwardBatch(context, Double.class,
        ...
        SpatialAveragePooling2dBackwardBatch spatialAvePooling2DLayerBackward = new SpatialAveragePooling2dBackwardBatch(context, Double.class,
                                                                                                                         SpatialAveragePooling2dMethod.defaultDense,
                                                                                                                         pyramidHeight, nDim);
