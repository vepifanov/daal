...
class TransConv2DLayerDenseBatch {
    ...
    public static void main(String[] args) throws java.io.FileNotFoundException, java.io.IOException {
        ...
        TransposedConv2dForwardBatch transposedConv2DLayerForward = new TransposedConv2dForwardBatch(context, Double.class, TransposedConv2dMethod.defaultDense);
        ...
        TransposedConv2dBackwardBatch transposedConv2DLayerBackward = new TransposedConv2dBackwardBatch(context, Double.class, TransposedConv2dMethod.defaultDense);
