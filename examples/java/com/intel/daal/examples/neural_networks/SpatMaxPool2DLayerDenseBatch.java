...
class SpatMaxPool2DLayerDenseBatch {
    ...
    public static void main(String[] args) throws java.io.FileNotFoundException, java.io.IOException {
        ...
        Service.printTensor("Forward two-dimensional maximum pooling input (first 10 rows):", dataTensor, 10, 0);

        /* Create an algorithm to compute forward two-dimensional pooling results using default method */
        SpatialMaximumPooling2dForwardBatch spatialMaxPooling2DLayerForward = new SpatialMaximumPooling2dForwardBatch(context, Double.class,
        ...
        Service.printTensor("Forward two-dimensional maximum pooling layer selected indices (first 5 rows):",
                            forwardResult.get(SpatialMaximumPooling2dLayerDataId.auxSelectedIndices), 5, 0);

        /* Create an algorithm to compute backward two-dimensional pooling results using default method */
        SpatialMaximumPooling2dBackwardBatch spatialMaxPooling2DLayerBackward = new SpatialMaximumPooling2dBackwardBatch(context, Double.class,
                                                                                                                         SpatialMaximumPooling2dMethod.defaultDense,
                                                                                                                         pyramidHeight, nDim);
