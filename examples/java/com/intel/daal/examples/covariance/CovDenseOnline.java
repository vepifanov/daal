...
class CovDenseOnline {
    ...
    public static void main(String[] args) throws java.io.FileNotFoundException, java.io.IOException {
        ...
        /* Create initialization procedure for setting parameters of the correlation or variance-covariance matrix algorithm */
        CovUserInitialization initializationProcedure = new CovUserInitialization(context, (int)input.getNumberOfColumns());

        /* Set initialization procedure to the algorithm */
        algorithm.parameter.setInitializationProcedure(initializationProcedure);
