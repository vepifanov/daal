...
class ReLUCSRBatch {
    ...
    public static void main(String[] args) throws java.io.FileNotFoundException, java.io.IOException {
        ...
        /* Create an algorithm */
        Batch reluAlgorithm = new Batch(context, Double.class, Method.fastCSR);
        ...
        Service.printNumericTable("First 5 rows of ReLU result:", (CSRNumericTable)result.get(ResultId.value), 5);
