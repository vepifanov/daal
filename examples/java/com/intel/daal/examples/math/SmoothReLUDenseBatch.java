...
class SmoothReLUDenseBatch {
    ...
    public static void main(String[] args) throws java.io.FileNotFoundException, java.io.IOException {
        ...
        /* Create an algorithm */
        Batch smoothReLUAlgorithm = new Batch(context, Double.class, Method.defaultDense);
        ...
        Service.printNumericTable("First 5 rows of SmoothReLU result:", result.get(ResultId.value), 5);
