...
/**
 * <a name="DAAL-EXAMPLE-JAVA-RELUDENSEBATCH">
 * @example ReLUDenseBatch.java
 */
...
class ReLUDenseBatch {
    ...
    public static void main(String[] args) throws java.io.FileNotFoundException, java.io.IOException {
        ...
        /* Create an algorithm */
        Batch reluAlgorithm = new Batch(context, Double.class, Method.defaultDense);
        ...
        Service.printNumericTable("First 5 rows of ReLU result:", result.get(ResultId.value), 5);
