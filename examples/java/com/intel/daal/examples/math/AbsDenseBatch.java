...
/**
 * <a name="DAAL-EXAMPLE-JAVA-ABSDENSEBATCH">
 * @example AbsDenseBatch.java
 */
...
class AbsDenseBatch {
    ...
    public static void main(String[] args) throws java.io.FileNotFoundException, java.io.IOException {
        ...
        /* Create an algorithm */
        Batch absAlgorithm = new Batch(context, Double.class, Method.defaultDense);
        ...
        Service.printNumericTable("First 5 rows of Abs result:", result.get(ResultId.value), 5);
