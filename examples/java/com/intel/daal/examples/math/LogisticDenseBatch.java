...
class LogisticDenseBatch {
    ...
    public static void main(String[] args) throws java.io.FileNotFoundException, java.io.IOException {
        ...
        /* Create an algorithm */
        Batch logisticAlgorithm = new Batch(context, Double.class, Method.defaultDense);
        ...
        Service.printNumericTable("First 5 rows of Logistic result:", result.get(ResultId.value), 5);
