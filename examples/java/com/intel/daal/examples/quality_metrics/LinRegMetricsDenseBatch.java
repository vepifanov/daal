...
class LinRegMetricsDenseBatch {
    ...
    private static void trainModel() {
        ...
        trainData = new HomogenNumericTable(context, Double.class, nFeatures, 0, NumericTable.AllocationFlag.NotAllocate);
        expectedResponses = new HomogenNumericTable(context, Double.class, nDependentVariables, 0,
    ...
    private static void printResults() {
        ...
        Service.printNumericTable("Determination coefficient for each dependent variable:", groupOfBetasResult.get(GroupOfBetasResultId.tSS), 10);
