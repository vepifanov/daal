...
class PCASVDDenseOnline {
    ...
    public static void main(String[] args) throws java.io.FileNotFoundException, java.io.IOException {
        ...
        Online pcaAlgorithm = new Online(context, Double.class, Method.svdDense);

        /* Set the input data */
        NumericTable data = dataSource.getNumericTable();
        pcaAlgorithm.input.set(InputId.data, data);

        /* Create initialization procedure for setting parameters of the PCA decomposition */
        PCASVDUserInitialization initializationProcedure = new PCASVDUserInitialization(context, (int)data.getNumberOfColumns());

        /* Set initialization procedure to the algorithm */
        pcaAlgorithm.parameter.setInitializationProcedure(initializationProcedure);
