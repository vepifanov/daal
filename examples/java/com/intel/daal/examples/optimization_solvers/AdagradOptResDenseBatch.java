...
class AdagradOptResDenseBatch {
    ...
    public static void main(String[] args) throws java.io.FileNotFoundException, java.io.IOException {
        ...
        Batch adagradAlgorithm = new Batch(context, Double.class, Method.defaultDense);
        adagradAlgorithm.parameter.setFunction(mseFunction);
        adagradAlgorithm.parameter.setLearningRate(new HomogenNumericTable(context, Double.class, 1, 1, NumericTable.AllocationFlag.DoAllocate, learningRate));
