...
/*
 //  Content:
 //     Java example of dense SGD in the batch processing mode
 //     processing mode
 ////////////////////////////////////////////////////////////////////////////////
 */

/**
 * <a name="DAAL-EXAMPLE-JAVA-SGDBATCH">
 * @example SGDDenseBatch.java
 */
...
class SGDDenseBatch {
    ...
    public static void main(String[] args) throws java.io.FileNotFoundException, java.io.IOException {
        ...
        Batch sgdAlgorithm = new Batch(context, Double.class, Method.defaultDense);
