 ...
 */
SharedPtr<classifier::quality_metric::binary_confusion_matrix::Result> ResultCollection::getResult(QualityMetricId id) const
{
 ...
 */
SharedPtr<classifier::quality_metric::binary_confusion_matrix::Input> InputDataCollection::getInput(QualityMetricId id) const
{
