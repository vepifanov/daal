...
public:
    ...
    services::KernelErrorCollectionPtr getErrors()
    {
        services::KernelErrorCollectionPtr p(new services::KernelErrorCollection(*_errors));
        p->add(_nt->getErrors());
        return p;
    }
...
protected:
    NumericTable *_nt;
    services::KernelErrorCollectionPtr _errors;
};
