...
{
public:
    void compute(size_t na, const NumericTable *const *a, Model *r, const Parameter *par);
};
...
{
public:
    void compute(size_t na, const NumericTable *const *a, PartialModel *r, const Parameter *par);
    void finalizeCompute(PartialModel *p, Model *r, const Parameter *par);
};
...
{
public:
    void merge(size_t na, PartialModel *const *a, PartialModel *r, const Parameter *par);
};
