...
void QROnlineKernel<algorithmFPType, method, cpu>::compute(const size_t na, const NumericTable *const *a,
 ...
 */
template <typename algorithmFPType, daal::algorithms::qr::Method method, CpuType cpu>
void QROnlineKernel<algorithmFPType, method, cpu>::finalizeCompute(const size_t na, const NumericTable *const *a,
                                                                   const size_t nr, NumericTable *r[], const daal::algorithms::Parameter *par)
{
    size_t i, j;
    qr::Parameter defaultParams;
    ...
    step2ntOut[0] = ntR;
    {
        ...
        {
            step2ntOut[1 + k] = new HomogenNumericTableCPU<algorithmFPType, cpu>(n, n);
        }
    }
