                                                           ...
                                                           const daal::algorithms::Parameter *par)
{
    ...
    {
        corDistanceFull<algorithmFPType, cpu>( xTable, rTable );
    }
    else
    {
        if(isLower<algorithmFPType, cpu>(rLayout))
        {
            corDistanceLowerPacked<algorithmFPType, cpu>( xTable, rTable );
        }
        else if(isUpper<algorithmFPType, cpu>(rLayout))
        {
            corDistanceUpperPacked<algorithmFPType, cpu>( xTable, rTable );
        }
        else
        {
