...
protected:
    inline void getNonEmptyClassMap(size_t &nClasses, const Model *model, size_t *nonEmptyClassMap);
    ...
    inline void get2ClassProbabilities(size_t nFeatures, size_t startRow, size_t nRows, size_t nClasses,
                                       const size_t *nonEmptyClassMap, MicroTable *mtX, algorithmFPType *y,
                                       services::SharedPtr<classifier::prediction::Batch> simplePrediction,
                                       Model *model,
