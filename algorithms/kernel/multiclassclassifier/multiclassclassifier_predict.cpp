 ...
 * \return          Input object that corresponds to the given identifier
 */
services::SharedPtr<multi_class_classifier::Model> Input::get(classifier::prediction::ModelInputId id) const
{
 ...
 * \param[in] ptr   Pointer to the input object
 */
void Input::set(classifier::prediction::ModelInputId id, const services::SharedPtr<multi_class_classifier::Model> &ptr)
{
    Argument::set(id, ptr);
}
