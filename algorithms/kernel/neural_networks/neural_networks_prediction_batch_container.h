...
void BatchContainer<algorithmFPType, method, cpu>::setupCompute()
{
    ...
    __DAAL_CALL_KERNEL(env, internal::NeuralNetworksFeedforwardPredictionKernel, __DAAL_KERNEL_ARGUMENTS(algorithmFPType, method), initialize,
...
{
    daal::services::Environment::env &env = *_env;
    __DAAL_CALL_KERNEL(env, internal::NeuralNetworksFeedforwardPredictionKernel, __DAAL_KERNEL_ARGUMENTS(algorithmFPType, method), reset);
}
} // namespace interface1
}
} // namespace neural_networks
