...
struct common_fullyconnected_data_t
{
    ...
    common_fullyconnected_data_t( Tensor *_inputTensor,
                                  Tensor *_wTensor,
                                  Tensor *_bTensor,
                                  ...
                                  const fullyconnected::Parameter *parameter )
    {
        ...
        bTensor->getSubtensor(0, 0, 0, outs_num, readOnly, bBlock);
        ...
        if((!iArray) || (!wArray) || (!bArray) || (!rArray))
        {
            malloc_errors++;
        }
...
void FullyconnectedKernel<algorithmFPType, method, cpu>::compute( Tensor *inputTensor,
                                                                  Tensor *wTensor,
                                                                  Tensor *bTensor,
                                                                  Tensor *resultTensor,
                                                                  const fullyconnected::Parameter *parameter )
