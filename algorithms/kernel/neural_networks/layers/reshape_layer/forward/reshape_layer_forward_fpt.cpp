...
DAAL_EXPORT void Result::allocate(const daal::algorithms::Input *input, const daal::algorithms::Parameter *parameter, const int method)
{
    ...
    if (!get(layers::forward::value))
    {
        ...
        DAAL_ALLOCATE_TENSOR_AND_SET(layers::forward::value, outDims);

        services::SharedPtr<data_management::HomogenNumericTable<size_t> >
            auxDimTable(new data_management::HomogenNumericTable<size_t> (inDims.size(), 1, data_management::NumericTable::doAllocate));
