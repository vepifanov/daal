...
public:
    ...
    void compute(Tensor *inputTensor, Tensor *inputPopulationMeanTensor,
                 Tensor *inputPopulationVarianceTensor, Tensor *weightsTensor, Tensor *biasesTensor,
                 Tensor *populationMeanTensor, Tensor *populationVarianceTensor, Tensor *valueTensor,
                 Tensor *meanTensor, Tensor *stDevTensor, const batch_normalization::Parameter *parameter);
