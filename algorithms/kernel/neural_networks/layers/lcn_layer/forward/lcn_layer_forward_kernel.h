...
{
public:
    void compute(Tensor *inputTensor,  Tensor *sigmaTensor, Tensor *cTensor, Tensor *resultTensor, Tensor *centeredDataTensor,
                 Tensor *invMaxTensor, const lcn::Parameter *parameter, Tensor *kernelTensor);
    void initialize(Tensor *inputTensor, Tensor *cTensor, Tensor *invMaxTensor, const lcn::Parameter *parameter, Tensor *kernelTensor);
    void reset();
protected:
