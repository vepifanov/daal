...
{
public:
    void compute(Tensor *auxCenteredDataTensor, Tensor *auxSigmaTensor, Tensor *auxCTensor,
                 Tensor *auxInvMaxTensor, Tensor *kernelTensor, Tensor *inGradTensor,
                 Tensor *gradientTensor, const lcn::Parameter *parameter);
    void initialize(Tensor *auxCenteredDataTensor, Tensor *auxSigmaTensor, Tensor *auxCTensor,
