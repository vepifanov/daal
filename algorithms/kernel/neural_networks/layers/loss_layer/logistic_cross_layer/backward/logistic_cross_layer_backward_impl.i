...
void LogisticCrossKernel<algorithmFPType, method, cpu>::compute(Tensor *inputTensor, Tensor *groundTruthTensor,
        const logistic_cross::Parameter *parameter, Tensor *resultTensor)
{
