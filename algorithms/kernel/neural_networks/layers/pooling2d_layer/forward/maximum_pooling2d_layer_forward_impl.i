                ...
                const algorithmFPType *data, algorithmFPType *valuePtr, int *selectedPosPtr)
{
    ...
    algorithmFPType max = -(data_feature_utils::internal::MaxVal<algorithmFPType>::get());
    int maxIdx = -1;
...
void PoolingKernel<algorithmFPType, method, cpu>::indicesLastZeroPaddingsCompute(
                ...
                int *selectedPos)
{
    const algorithmFPType minValue = -(data_feature_utils::internal::MaxVal<algorithmFPType>::get());
