        ...
        Tensor *selectedPosTensor, const Parameter *parameter)
{
    ...
    ReadSubtensor<algorithmFPType, cpu, Tensor> dataSubtensor(dataTensor, 0, 0, 0, targetInLayout.getDimensions()[0], targetInLayout);
...
void PoolingKernel<algorithmFPType, method, cpu>::getUniformRandFrom0to1(int *uniformRand, size_t nUniformRand, size_t seed)
{
    ...
    int errCode = rng.uniform(nUniformRand, uniformRand, baseRng, 0, intMaxVal);
