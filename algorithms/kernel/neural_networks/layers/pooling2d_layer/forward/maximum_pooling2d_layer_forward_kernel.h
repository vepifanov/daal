...
public:
    ...
    void initialize(const services::Collection<size_t>& inDimsFull, const maximum_pooling2d::Parameter *parameter,
...
protected:
    ...
    void indicesLastZeroPaddingsCompute(pooling2d::internal::Parameter &parameter,
                const algorithmFPType *data, algorithmFPType *value,
                int *selectedPos);

    void indicesFirstZeroPaddingsCompute(pooling2d::internal::Parameter &parameter,
                const algorithmFPType *data, algorithmFPType *value,
                int *selectedPos);
