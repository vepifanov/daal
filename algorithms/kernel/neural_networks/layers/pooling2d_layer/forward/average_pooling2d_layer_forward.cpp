/* file: average_pooling2d_layer_forward.cpp */
/*******************************************************************************
...
#include "average_pooling2d_layer_forward_types.h"
...
{
__DAAL_REGISTER_SERIALIZATION_CLASS(Result, SERIALIZATION_NEURAL_NETWORKS_LAYERS_AVERAGE_POOLING2D_FORWARD_RESULT_ID);
/**
 * Default constructor
 */
Result::Result() {}
