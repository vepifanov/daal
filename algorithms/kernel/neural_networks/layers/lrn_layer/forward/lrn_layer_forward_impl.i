        ...
        Tensor *resultTensor)
{
    ...
    {
        dnnLayout_t inputLayout = (dnnLayout_t)inputMklTensor->getLayout();
        ...
        lrnRes[dnnResourceSrc] = inputMklTensor->getArray();
        lrnRes[dnnResourceWorkspace] = sMinusBetaMklTensor->getArray();
        lrnRes[dnnResourceDst] = resultMklTensor->getArray();
