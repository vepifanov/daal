/* file: average_pooling1d_layer_backward.cpp */
/*******************************************************************************
...
{
__DAAL_REGISTER_SERIALIZATION_CLASS(Result, SERIALIZATION_NEURAL_NETWORKS_LAYERS_AVERAGE_POOLING1D_BACKWARD_RESULT_ID);
/**
 * Default constructor
 */
Input::Input() {}
