...
{
public:
    void compute(Tensor *inputTensor, Tensor *resultTensor, Tensor *maskTensor, const dropout::Parameter *parameter);

    void initialize(const dropout::Parameter *parameter);
