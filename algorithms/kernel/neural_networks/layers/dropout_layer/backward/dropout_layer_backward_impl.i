...
void DropoutKernel<algorithmFPType, method, cpu>::compute(Tensor *inputGradientTable, Tensor *maskTable, Tensor *resultTable, const dropout::Parameter *parameter)
{
...
template<typename algorithmFPType, Method method, CpuType cpu>
inline void DropoutKernel<algorithmFPType, method, cpu>::processBlock(Tensor *inputGradientTable,
