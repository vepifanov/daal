...
public:
    ...
    {
        return data_feature_utils::getIndexNumType<modelFPType>() + SERIALIZATION_NEURAL_NETWORKS_TENSOR_WEIGHTS_AND_BIASES_ID;
    }
...
public:
    ...
    int getSerializationTag() const DAAL_C11_OVERRIDE
    {
        return data_feature_utils::getIndexNumType<modelFPType>() + SERIALIZATION_NEURAL_NETWORKS_TENSOR_WEIGHTS_AND_BIASES_DERIVATIVES_ID;
    }
...
public:
    ...
    int getSerializationTag() const DAAL_C11_OVERRIDE
    {
        return data_feature_utils::getIndexNumType<modelFPType>() + SERIALIZATION_NEURAL_NETWORKS_NUMERIC_TABLE_WEIGHTS_AND_BIASES_ID;
    }
...
public:
    ...
    int getSerializationTag() const DAAL_C11_OVERRIDE
    {
        return data_feature_utils::getIndexNumType<modelFPType>() + SERIALIZATION_NEURAL_NETWORKS_NUMERIC_TABLE_WEIGHTS_AND_BIASES_DERIVATIVES_ID;
    }
