/* file: truncated_gaussian_batch_container.h */
/*******************************************************************************
...
void BatchContainer<algorithmFPType, method, cpu>::compute()
{
    ...
    truncated_gaussian::Parameter<algorithmFPType> *parameter = static_cast<truncated_gaussian::Parameter<algorithmFPType> *>(_par);;
    daal::services::Environment::env &env = *_env;

    __DAAL_CALL_KERNEL(env, internal::TruncatedGaussianKernel, __DAAL_KERNEL_ARGUMENTS(algorithmFPType, method), compute, parameter, result->get(initializers::value).get());
}
} // namespace interface1
} // namespace truncated_gaussian
} // namespace initializers
