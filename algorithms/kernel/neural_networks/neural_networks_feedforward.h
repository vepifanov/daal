...
bool processLayerErrors(size_t layerId,
                        const services::SharedPtr<services::KernelErrorCollection> &layerErrors,
                        services::SharedPtr<services::KernelErrorCollection> &netErrors);
