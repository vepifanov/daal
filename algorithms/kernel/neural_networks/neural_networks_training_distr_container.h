...
template<typename algorithmFPType, Method method, CpuType cpu>
void DistributedContainer<step1Local, algorithmFPType, method, cpu>::setupCompute()
{
    DistributedInput<step1Local> *input = static_cast<DistributedInput<step1Local> *>(_in);
    Parameter *parameter = static_cast<Parameter *>(_par);
    daal::services::Environment::env &env = *_env;
...
template<typename algorithmFPType, Method method, CpuType cpu>
void DistributedContainer<step1Local, algorithmFPType, method, cpu>::resetCompute()
{
    daal::services::Environment::env &env = *_env;
...
template<typename algorithmFPType, Method method, CpuType cpu>
void DistributedContainer<step2Master, algorithmFPType, method, cpu>::setupCompute()
{}

template<typename algorithmFPType, Method method, CpuType cpu>
void DistributedContainer<step2Master, algorithmFPType, method, cpu>::resetCompute()
{}
