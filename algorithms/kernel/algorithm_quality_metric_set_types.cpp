...
InputDataCollection::InputDataCollection() : data_management::KeyValueDataCollection() {}
 ...
 */
void InputDataCollection::add(size_t k, const services::SharedPtr<algorithms::Input>& ptr)
{
    (*this)[k] = ptr;
}
 ...
 */
services::SharedPtr<algorithms::Input> InputDataCollection::getInput(size_t key) const
{
...
void ResultCollection::add(size_t key, const services::SharedPtr<algorithms::Result>& ptr)
{
    (*this)[key] = ptr;
}

services::SharedPtr<algorithms::Result> ResultCollection::getResult(size_t key) const
{
