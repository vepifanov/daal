/* file: logitboost_quality_metric_set_types.cpp */
/*******************************************************************************
 ...
 */
SharedPtr<classifier::quality_metric::multiclass_confusion_matrix::Result> ResultCollection::getResult(QualityMetricId id) const
{
 ...
 */
SharedPtr<classifier::quality_metric::multiclass_confusion_matrix::Input> InputDataCollection::getInput(QualityMetricId id) const
{
