 ...
 * \return          %Input object that corresponds to the given identifier
 */
SharedPtr<logitboost::Model> Input::get(classifier::prediction::ModelInputId id) const
{
 ...
 * \param[in] ptr   Pointer to the input object
 */
void Input::set(classifier::prediction::ModelInputId id, const SharedPtr<logitboost::Model> &ptr)
{
    Argument::set(id, ptr);
}
