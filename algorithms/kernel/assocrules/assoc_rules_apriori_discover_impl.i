...
assocrules_itemset<cpu> *AssociationRulesKernel<apriori, algorithmFPType, cpu>::findItemSet(
 ...
 *
  */
template<typename algorithmFPType, CpuType cpu>
void AssociationRulesKernel<apriori, algorithmFPType, cpu>::setIntersection(size_t *a, size_t aSize, size_t *b, size_t bSize,
 ...
 */
template<typename algorithmFPType, CpuType cpu>
void AssociationRulesKernel<apriori, algorithmFPType, cpu>::generateRules(double minConfidence, size_t minItemsetSize,
...
template<typename algorithmFPType, CpuType cpu>
void AssociationRulesKernel<apriori, algorithmFPType, cpu>::setRules(AssocRule<cpu> **rulesArray, size_t numRules,
                                                                     int *rleft, int *rright, algorithmFPType *rconf)
{
