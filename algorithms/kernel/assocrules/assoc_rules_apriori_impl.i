...
void AssociationRulesKernel<apriori, algorithmFPType, cpu>::compute(const NumericTable *a, size_t nr, NumericTable *r[],
...
template <typename algorithmFPType, CpuType cpu>
void AssociationRulesKernel<apriori, algorithmFPType, cpu>::findLargeItemsets(size_t minSupport, size_t maxItemsetSize,
...
template <typename algorithmFPType, CpuType cpu>
void AssociationRulesKernel<apriori, algorithmFPType, cpu>::allocateItemsetsTableData(ItemSetList<cpu> *L, size_t L_size,
...
template <typename algorithmFPType, CpuType cpu>
void AssociationRulesKernel<apriori, algorithmFPType, cpu>::writeItemsetsTableData(ItemSetList<cpu> *L, size_t L_size,
...
template <typename algorithmFPType, CpuType cpu>
void AssociationRulesKernel<apriori, algorithmFPType, cpu>::allocateRulesTableData(
...
template <typename algorithmFPType, CpuType cpu>
void AssociationRulesKernel<apriori, algorithmFPType, cpu>::writeRulesTableData(AssocRule<cpu> *R, RulesOrder rulesOrder,
        NumericTable *leftItemsTable, NumericTable *rightItemsTable, NumericTable *confidenceTable)
{
    ...
    FeatureMicroTable<algorithmFPType, writeOnly, cpu> mtConfidence(confidenceTable);

    int *leftItems, *rightItems;
    algorithmFPType *confidence;
...
template <typename algorithmFPType, CpuType cpu>
void AssociationRulesKernel<apriori, algorithmFPType, cpu>::allocateTableData(NumericTable *table, size_t nRows, const services::ErrorID &errorcode)
{
