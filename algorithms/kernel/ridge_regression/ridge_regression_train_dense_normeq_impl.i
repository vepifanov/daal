...
static void getModelPartialSums(ModelNormEq *model, DAAL_INT dim, DAAL_INT ny, ReadWriteMode rwmode,
 ...
 */
template <typename algorithmFpType, CpuType cpu>
static void computeRidgeCoeffs(DAAL_INT *p, algorithmFpType *xtx, DAAL_INT *ldxtx, DAAL_INT *ny, algorithmFpType *xty, DAAL_INT *ldxty,
                               bool isEqualRidge, bool interceptFlag, algorithmFpType *ridge, algorithmFpType *beta,
                         ...
                         services::KernelErrorCollection *errors)
{
    ...
    DAAL_INT nBetasIntercept = nBetas;
    if (!interceptFlag) { nBetasIntercept--; }
    ...
    computeRidgeCoeffs<algorithmFpType, cpu>(&nBetasIntercept, xtx, &nBetasIntercept, &nResponses, xty, &nBetasIntercept,
                                             (ridgeParamsNumberOfRows == 1), interceptFlag, ridgeParamsBD.getBlockPtr(), betaBuffer, errors);
