...
public:
    ...
    virtual ghSumTypeVector* getGHSumBuf(size_t size) = 0;
...
public:
    ...
    virtual typename super::ghSumTypeVector* getGHSumBuf(size_t size) DAAL_C11_OVERRIDE{ return &_aGHSum; }
...
public:
    ...
    virtual typename super::ghSumTypeVector* getGHSumBuf(size_t size) DAAL_C11_OVERRIDE
    {
        return _tlsGHSum.local(size);
    }
