/* file: gbt_classification_train_dense_default_oneapi_impl.i */
/*******************************************************************************
...
#ifndef __GBT_CLASSIFICATION_TRAIN_DENSE_DEFAULT_ONEAPI_IMPL_I__
#define __GBT_CLASSIFICATION_TRAIN_DENSE_DEFAULT_ONEAPI_IMPL_I__

#include "cl_kernels/gbt_batch_classification_kernels.cl"

#include "oneapi/gbt_feature_type_helper_oneapi.i"
#include "gbt_classification_model_impl.h"
#include "../gbt_classification_tree_impl.h"
...
using namespace daal::algorithms::gbt::classification::internal;
...
static void __buildProgram(ClKernelFactoryIface& factory)
{
    DAAL_ITTNOTIFY_SCOPED_TASK(compute.buildProgram);
    {
        ...
        services::String cachekey("__daal_algorithms_gbt_batch_classification_");
        cachekey.add(fptype_name);
        factory.build(ExecutionTargetIds::device, cachekey.c_str(), gbt_batch_classification_kernels, build_options.c_str());
    }
}

template <typename algorithmFPType, gbt::classification::training::Method method>
services::Status ClassificationTrainBatchKernelOneAPI<algorithmFPType, method>::scan(const services::Buffer<algorithmFPType>& values,
...
template <typename algorithmFPType, gbt::classification::training::Method method>
services::Status ClassificationTrainBatchKernelOneAPI<algorithmFPType, method>::reduce(UniversalBuffer& partialSums,
...
template <typename algorithmFPType, gbt::classification::training::Method method>
services::Status ClassificationTrainBatchKernelOneAPI<algorithmFPType, method>::getInitialResponse(NumericTable& y, algorithmFPType *response)
{
...
template <typename algorithmFPType, gbt::classification::training::Method method>
services::Status ClassificationTrainBatchKernelOneAPI<algorithmFPType, method>::computeOptCoeffs(NumericTable& y,
...
template <typename algorithmFPType, gbt::classification::training::Method method>
services::Status ClassificationTrainBatchKernelOneAPI<algorithmFPType, method>::initializeTreeOrder(size_t nRows,
...
template <typename algorithmFPType, gbt::classification::training::Method method>
services::Status ClassificationTrainBatchKernelOneAPI<algorithmFPType, method>::computePartialHistograms(const UniversalBuffer& data,
                                                                                                     UniversalBuffer& treeOrder,
                                                                                                     UniversalBuffer& optCoeffs,
...
template <typename algorithmFPType, gbt::classification::training::Method method>
services::Status ClassificationTrainBatchKernelOneAPI<algorithmFPType, method>::reducePartialHistograms(UniversalBuffer& partialHistograms,
...
template <typename algorithmFPType, gbt::classification::training::Method method>
services::Status ClassificationTrainBatchKernelOneAPI<algorithmFPType, method>::computeHistogram(const UniversalBuffer& data,
                                                                                             UniversalBuffer& treeOrder,
                                                                                             UniversalBuffer& optCoeffs,
                                                                                             UniversalBuffer& partialHistograms,
                                                                                             UniversalBuffer& histograms,
...
template <typename algorithmFPType, gbt::classification::training::Method method>
services::Status ClassificationTrainBatchKernelOneAPI<algorithmFPType, method>::computeHistogramDiff(UniversalBuffer& histogramSrc,
...
template <typename algorithmFPType, gbt::classification::training::Method method>
services::Status ClassificationTrainBatchKernelOneAPI<algorithmFPType, method>::computeTotalOptCoeffs(UniversalBuffer& histogram,
...
template <typename algorithmFPType, gbt::classification::training::Method method>
services::Status ClassificationTrainBatchKernelOneAPI<algorithmFPType, method>::computeBestSplitForFeatures(UniversalBuffer& histogram,
                                                                                                        UniversalBuffer& totalOptCoeffs,
...
template <typename algorithmFPType, gbt::classification::training::Method method>
services::Status ClassificationTrainBatchKernelOneAPI<algorithmFPType, method>::computeBestSplit(UniversalBuffer& histograms,
                                                                                             UniversalBuffer& binOffsets,
                                                                                             size_t nTotalBins,
                                                                                             size_t nFeatures,
                                                                                             algorithmFPType lambda,
...
template <typename algorithmFPType, gbt::classification::training::Method method>
services::Status ClassificationTrainBatchKernelOneAPI<algorithmFPType, method>::partitionScan(const UniversalBuffer& data,
                                                                                          UniversalBuffer& treeOrder,
                                                                                          UniversalBuffer& partialSums,
                                                                                          int splitValue,
                                                                                          size_t iStart,
...
template <typename algorithmFPType, gbt::classification::training::Method method>
services::Status ClassificationTrainBatchKernelOneAPI<algorithmFPType, method>::partitionSumScan(UniversalBuffer& partialSums,
...
template <typename algorithmFPType, gbt::classification::training::Method method>
services::Status ClassificationTrainBatchKernelOneAPI<algorithmFPType, method>::partitionReorder(const UniversalBuffer& data,
                                                                                             UniversalBuffer& treeOrder,
...
template <typename algorithmFPType, gbt::classification::training::Method method>
services::Status ClassificationTrainBatchKernelOneAPI<algorithmFPType, method>::partitionCopy(UniversalBuffer& treeOrderBuf,
                                                                                          UniversalBuffer& treeOrder,
                                                                                          size_t iStart,
                                                                                          size_t nRows)
{
...
template <typename algorithmFPType, gbt::classification::training::Method method>
services::Status ClassificationTrainBatchKernelOneAPI<algorithmFPType, method>::doPartition(const UniversalBuffer& data,
                                                                                        UniversalBuffer& treeOrder,
                                                                                        UniversalBuffer& treeOrderBuf,
                                                                                        int splitValue,
                                                                                        size_t iStart,
...
template <typename algorithmFPType, gbt::classification::training::Method method>
services::Status ClassificationTrainBatchKernelOneAPI<algorithmFPType, method>::updateResponse(UniversalBuffer& treeOrder,
                                                                                           UniversalBuffer& response,
                                                                                           size_t iStart,
                                                                                           size_t nRows,
                                                                                           algorithmFPType inc)
...
//////////////////////////////////////////////////////////////////////////////////////////
template <typename algorithmFPType, gbt::classification::training::Method method>
services::Status ClassificationTrainBatchKernelOneAPI<algorithmFPType, method>::compute(
    HostAppIface* pHostApp, const NumericTable *x, const NumericTable *y, gbt::classification::Model& m, Result& res, const Parameter& par,
    engines::internal::BatchBaseImpl& engine)
{
    ...
    gbt::internal::ModelImpl &modelImpl = *static_cast<daal::algorithms::gbt::classification::internal::ModelImpl*>(&m);
