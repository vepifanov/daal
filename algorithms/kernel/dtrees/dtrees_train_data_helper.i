...
bool isPositive(algorithmFPType val, algorithmFPType eps = algorithmFPType(10)*daal::data_feature_utils::internal::EpsilonVal<algorithmFPType>::get())
{
    return (val > eps);
}

template <typename algorithmFPType, CpuType cpu>
bool isZero(algorithmFPType val, algorithmFPType eps = algorithmFPType(10)*daal::data_feature_utils::internal::EpsilonVal<algorithmFPType>::get())
{
...
struct SplitData
{
    ...
    SplitData() : impurityDecrease(-daal::data_feature_utils::internal::MaxVal<algorithmFPType>::get()) {}
