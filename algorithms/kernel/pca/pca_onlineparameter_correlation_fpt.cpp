...
template DAAL_EXPORT OnlineParameter<DAAL_FPTYPE, correlationDense>::OnlineParameter(const services::SharedPtr<covariance::OnlineIface> &covariance,
    const services::SharedPtr<PartialResultsInitIface<correlationDense> > &initializationProcedure);
template DAAL_EXPORT void OnlineParameter<DAAL_FPTYPE, correlationDense>::check() const;
