...
void PCASVDStep2MasterKernel<algorithmFPType, cpu>::finalizeMerge(const data_management::DataCollectionPtr &inputPartialResults,
                                                                  ...
                                                                  data_management::NumericTablePtr &eigenvectors)
{
    ...
    for(size_t i = 0; i < nPartialResults; i++)
    {
        ...
        algorithmFPType *nCurrentObservations = block.getBlockPtr();
