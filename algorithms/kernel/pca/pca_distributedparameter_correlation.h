...
template<typename algorithmFPType>
DAAL_EXPORT void DistributedParameter<step2Master, algorithmFPType, correlationDense>::check() const
{
    DAAL_CHECK(covariance, ErrorNullAuxiliaryAlgorithm);
    DAAL_CHECK(this->initializationProcedure, ErrorNullInitializationProcedure);
}
