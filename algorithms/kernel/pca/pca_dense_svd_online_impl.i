...
void PCASVDOnlineKernel<algorithmFPType, cpu>::compute(const data_management::NumericTablePtr &data,
...
template <typename algorithmFPType, CpuType cpu>
void PCASVDOnlineKernel<algorithmFPType, cpu>::finalizeMerge(const data_management::NumericTablePtr &nObservationsTable,
...
template <typename algorithmFPType, CpuType cpu>
void PCASVDOnlineKernel<algorithmFPType, cpu>::decompose()
{
    svd::Parameter kmPar;
    kmPar.leftSingularMatrix = svd::notRequired;
...
template <typename algorithmFPType, CpuType cpu>
void PCASVDOnlineKernel<algorithmFPType, cpu>::normalizeDataset()
{
