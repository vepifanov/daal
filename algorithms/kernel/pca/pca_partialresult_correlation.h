...
DAAL_EXPORT void PartialResultImpl<algorithmFPType, correlationDense>::allocate(const daal::algorithms::Input *input, const daal::algorithms::Parameter *parameter, const int method)
{
    ...
    set(crossProductCorrelation,
        data_management::NumericTablePtr(
            new data_management::HomogenNumericTable<double>((static_cast<const InputIface *>(input))->getNFeatures(),
