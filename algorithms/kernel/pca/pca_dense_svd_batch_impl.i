...
void PCASVDBatchKernel<algorithmFPType, cpu>::compute(const data_management::NumericTablePtr &data,
...
template <typename algorithmFPType, CpuType cpu>
void PCASVDBatchKernel<algorithmFPType, cpu>::normalizeDataset()
{
...
template <typename algorithmFPType, CpuType cpu>
void PCASVDBatchKernel<algorithmFPType, cpu>::decompose()
{
