...
{
    algorithmFPtype minS = daal::data_feature_utils::internal::MaxVal<algorithmFPtype>::get();
    ...
    daal::tls<TGroupRes *> tls( [ = ]()-> TGroupRes *
    {
        ...
        g->groupMinS = daal::data_feature_utils::internal::MaxVal<algorithmFPtype>::get();
        return g;
    } );
    ...
    daal::threader_for(dim, dim, [=, &safeStat, &nCategoricalFeaturesSkipped, &tls](size_t k)
    {
        ...
        algorithmFPtype localMinS = daal::data_feature_utils::internal::MaxVal<algorithmFPtype>::get();
