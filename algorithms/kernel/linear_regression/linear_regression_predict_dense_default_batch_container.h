...
{
    __DAAL_INITIALIZE_KERNELS(internal::LinearRegressionPredictKernel, algorithmFPType, method);
}
...
void BatchContainer<algorithmFPType, method, cpu>::compute()
{
    ...
    __DAAL_CALL_KERNEL(env, internal::LinearRegressionPredictKernel, __DAAL_KERNEL_ARGUMENTS(algorithmFPType, method), compute, a, m, r, par);
}
