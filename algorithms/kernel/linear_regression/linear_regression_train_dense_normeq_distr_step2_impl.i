...
void LinearRegressionTrainDistributedKernel<algorithmFPType, training::normEqDense, cpu>::compute(
...
template <typename algorithmFPType, CpuType cpu>
void LinearRegressionTrainDistributedKernel<algorithmFPType, training::normEqDense, cpu>::merge(
...
template <typename algorithmFPType, CpuType cpu>
void LinearRegressionTrainDistributedKernel<algorithmFPType, training::normEqDense, cpu>::finalizeCompute(
