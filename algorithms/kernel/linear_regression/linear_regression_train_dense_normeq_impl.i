...
template <typename algorithmFPType, CpuType cpu>
void LinearRegressionTrainBatchKernel<algorithmFPType, training::normEqDense, cpu>::compute(
...
template <typename algorithmFPType, CpuType cpu>
void LinearRegressionTrainOnlineKernel<algorithmFPType, training::normEqDense, cpu>::compute(
    NumericTable *x, NumericTable *y, linear_regression::Model *r,
    const daal::algorithms::Parameter *par)
{
    bool isOnline = true;
...
template <typename algorithmFPType, CpuType cpu>
void LinearRegressionTrainOnlineKernel<algorithmFPType, training::normEqDense, cpu>::finalizeCompute(
