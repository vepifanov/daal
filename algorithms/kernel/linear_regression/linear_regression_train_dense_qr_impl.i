...
static void mallocQRWorkBuffer(DAAL_INT *p, DAAL_INT *n, algorithmFPType *x, DAAL_INT *ny, algorithmFPType *y, algorithmFPType *tau,
                               TScalablePtr<algorithmFPType, cpu> &work, DAAL_INT *lwork, services::KernelErrorCollection *_errors)
{
    DAAL_INT info = 0;
    DAAL_INT lwork1;
                          ...
                          services::KernelErrorCollection *_errors)
{
    ...
    TScalablePtr<algorithmFPType, cpu> qrROld, qrQTYOld, qrRMerge, qrQTYMerge;
    if (isOnline)
    {
    ...
    DAAL_INT lwork = -1;
    TScalablePtr<algorithmFPType, cpu> tau(nBetasIntercept );
    TScalablePtr<algorithmFPType, cpu> qrBuffer(nBetasIntercept * nRows );
    TScalablePtr<algorithmFPType, cpu> qtyBuffer(nResponses * nRows );
    TScalablePtr<algorithmFPType, cpu> work;
...
struct tls_task_t
{
    ...
    TScalablePtr<algorithmFPType, cpu> work;
    TScalablePtr<algorithmFPType, cpu> tau;
    TScalablePtr<algorithmFPType, cpu> qrBuffer;
    TScalablePtr<algorithmFPType, cpu> qtyBuffer;

    TScalablePtr<algorithmFPType, cpu> qrR;
    TScalablePtr<algorithmFPType, cpu> qrQTY;

    TScalablePtr<algorithmFPType, cpu> qrRNew;
    TScalablePtr<algorithmFPType, cpu> qrQTYNew;
    TScalablePtr<algorithmFPType, cpu> qrRMerge;
    TScalablePtr<algorithmFPType, cpu> qrQTYMerge;
