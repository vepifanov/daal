...
void LinearRegressionTrainDistributedKernel<algorithmFPType, training::qrDense, cpu>::compute(
    size_t n,
...
template <typename algorithmFPType, CpuType cpu>
void LinearRegressionTrainDistributedKernel<algorithmFPType, training::qrDense, cpu>::finalizeCompute(
