...
Status SVDBatchKernel<algorithmFPType, method, cpu>::compute(const size_t na, const NumericTable *const *a,
...
template <typename algorithmFPType, daal::algorithms::svd::Method method, CpuType cpu>
Status SVDBatchKernel<algorithmFPType, method, cpu>::compute_seq(const size_t na, const NumericTable *const *a,
                                                               const size_t nr, NumericTable *r[], const Parameter *svdPar)
{
    ...
    {
        WriteOnlyRows<algorithmFPType, cpu, NumericTable> vBlock(r[2], 0, n);
...
*/
template <typename algorithmFPType, daal::algorithms::svd::Method method, CpuType cpu>
Status SVDBatchKernel<algorithmFPType, method, cpu>::compute_thr(const size_t na, const NumericTable *const *a,
                                                               const size_t nr, NumericTable *r[], const Parameter *svdPar)
{
    ...
    algorithmFPType *S_output = bkS_output.get();
    ...
    if (svdPar->rightSingularMatrix == requiredInPackedForm)
    {
        V_output = bkV_output.set(ntV_output, 0, n);
...
template <typename algorithmFPType, daal::algorithms::svd::Method method, CpuType cpu>
Status SVDBatchKernel<algorithmFPType, method, cpu>::compute_pcl(const size_t na, const NumericTable *const *a,
                                                               const size_t nr, NumericTable *r[], const Parameter *svdPar)
{
    NumericTable *ntA    = const_cast<NumericTable *>(a[0]);
    ...
    algorithmFPType *Sigma = sBlock.get();
