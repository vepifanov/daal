                                                           ...
                                                           const size_t nr, NumericTable *r[], const daal::algorithms::Parameter *par)
{
    ...
    if(m >= 2*n)
    {
        ...
        {
            SVDBatchKernel<algorithmFPType, method, cpu>::compute_pcl( na, a, nr, r, par);
        }
        else
        {
...
template <typename algorithmFPType, daal::algorithms::svd::Method method, CpuType cpu>
void SVDBatchKernel<algorithmFPType, method, cpu>::compute_pcl(const size_t na, const NumericTable *const *a,
                                                               const size_t nr, NumericTable *r[], const daal::algorithms::Parameter *par)
{
    size_t i, j;
    svd::Parameter defaultParams;
    ...
    algorithmFPType *A     = NULL;
    algorithmFPType *Sigma = NULL;
    ...
    services::ErrorID st = (services::ErrorID)svd_pcl<algorithmFPType,cpu>( A, m, n, needsU, Q, Sigma, needsVT, V );
