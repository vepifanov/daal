...
void BatchContainer<algorithmFPType, method, cpu>::compute()
{
    ...
    __DAAL_CALL_KERNEL(env, internal::SVDBatchKernel, __DAAL_KERNEL_ARGUMENTS(algorithmFPType, method), compute, na, a,
                       nr, r, par);
}
...
void OnlineContainer<algorithmFPType, method, cpu>::compute()
{
    ...
    partialResult->addPartialResultStorage<algorithmFPType>(m, n, kmPar);
    ...
    __DAAL_CALL_KERNEL(env, internal::SVDOnlineKernel, __DAAL_KERNEL_ARGUMENTS(algorithmFPType, method), compute, na, a,
                       nr, r, &kmPar);
}
...
void OnlineContainer<algorithmFPType, method, cpu>::finalizeCompute()
{
    ...
    __DAAL_CALL_KERNEL(env, internal::SVDOnlineKernel, __DAAL_KERNEL_ARGUMENTS(algorithmFPType, method), finalizeCompute, na, a, nr, r, &kmPar);
...
void DistributedContainer<step2Master, algorithmFPType, method, cpu>::compute()
{
    ...
    __DAAL_CALL_KERNEL(env, internal::SVDDistributedStep2Kernel, __DAAL_KERNEL_ARGUMENTS(algorithmFPType, method), compute, na, a, nr, r, par);
...
template<typename algorithmFPType, Method method, CpuType cpu>
void DistributedContainer<step3Local, algorithmFPType, method, cpu>::compute()
{
...
template<typename algorithmFPType, Method method, CpuType cpu>
void DistributedContainer<step3Local, algorithmFPType, method, cpu>::finalizeCompute() {}
