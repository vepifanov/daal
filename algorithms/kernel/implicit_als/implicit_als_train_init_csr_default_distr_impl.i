...
{
    CSRBlockMicroTable<algorithmFPType, readOnly, cpu> mtData(data);
    ...
    BlockMicroTable<algorithmFPType, writeOnly, cpu> partialFactors(itemsFactorsTable);
    ...
    {
        this->randFactors(1, nFactors, itemsFactors + i * nFactors, (int *)randBuffer, rng, baseRng, this->_errors.get());
    }
