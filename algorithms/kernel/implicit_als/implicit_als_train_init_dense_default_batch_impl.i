            ...
            const NumericTable *dataTable, NumericTable *itemsFactorsTable, const Parameter *parameter)
{
    ...
    Blas<algorithmFPType, cpu>::xgemv(&transa, (DAAL_INT *)&nItems, (DAAL_INT *)&nUsers, &alpha, data, (DAAL_INT *)&nItems,
                       ones, (DAAL_INT *)&ione, &beta, itemsSum, (DAAL_INT *)&ione);
    mtData.release();
    ...
    RNGs<int, cpu> rng;
    this->randFactors(nItems, nFactors, itemsFactors, (int *)itemsSum, rng, baseRng, this->_errors.get());
