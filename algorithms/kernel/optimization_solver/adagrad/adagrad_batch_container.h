...
void BatchContainer<algorithmFPType, method, cpu>::compute()
{
    ...
    __DAAL_CALL_KERNEL(env, internal::AdagradKernel, __DAAL_KERNEL_ARGUMENTS(algorithmFPType, method), compute, inputArgument, minimum, nIterations,
                                                                            gradientSquareSumResult, gradientSquareSumInput, optionalArgument,
                                                                            optionalResult, parameter);
}
