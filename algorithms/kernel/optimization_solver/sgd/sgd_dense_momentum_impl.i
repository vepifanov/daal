        ...
        NumericTable *batchIndices, OptionalArgument *optionalArgument, OptionalArgument *optionalResult, engines::BatchBase &engine)
{
    ...
    DAAL_CHECK_STATUS(s, task.init(batchIndices, minimum, parameter,
...
template<typename algorithmFPType, CpuType cpu>
services::Status SGDmomentumTask<algorithmFPType, cpu>::makeStep(
...
template<typename algorithmFPType, CpuType cpu>
Status SGDmomentumTask<algorithmFPType, cpu>::init(NumericTable *batchIndicesTable,
    NumericTable *resultTable, Parameter<momentum> *parameter,
    ...
    NumericTable *lastIterationInput)
{
    ...
    {
        SharedPtr<HomogenNumericTableCPU<algorithmFPType, cpu>> pastUpdateCpuNt(new HomogenNumericTableCPU<algorithmFPType, cpu>(1, argumentSize, s));
