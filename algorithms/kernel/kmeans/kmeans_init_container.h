...
void DistributedContainer<step1Local, algorithmFPType, method, cpu>::compute()
{
    ...
    Parameter *par = static_cast<Parameter *>(_par);
    daal::services::Environment::env &env = *_env;
    __DAAL_CALL_KERNEL(env, internal::KMeansinitStep1LocalKernel, __DAAL_KERNEL_ARGUMENTS(method, algorithmFPType), compute, pData, par,
        pNumPartialClusters, pPartialClusters);
...
void DistributedContainer<step2Master, algorithmFPType, method, cpu>::finalizeCompute()
{
    ...
    __DAAL_CALL_KERNEL(env, internal::KMeansinitStep2MasterKernel, __DAAL_KERNEL_ARGUMENTS(method, algorithmFPType),
...
template<typename algorithmFPType, Method method, CpuType cpu>
void DistributedContainer<step2Local, algorithmFPType, method, cpu>::compute()
{
...
template<typename algorithmFPType, Method method, CpuType cpu>
void DistributedContainer<step2Local, algorithmFPType, method, cpu>::finalizeCompute() {}
...
template<typename algorithmFPType, Method method, CpuType cpu>
void DistributedContainer<step3Master, algorithmFPType, method, cpu>::compute()
{
    ...
    __DAAL_CALL_KERNEL(env, internal::KMeansinitStep3MasterKernel, __DAAL_KERNEL_ARGUMENTS(method, algorithmFPType), compute,
        (const Parameter*)(_par), input->get(inputOfStep3FromStep2).get(), pRngState, pr->get(outputOfStep3ForStep4).get());
}

template<typename algorithmFPType, Method method, CpuType cpu>
void DistributedContainer<step3Master, algorithmFPType, method, cpu>::finalizeCompute() {}
...
template<typename algorithmFPType, Method method, CpuType cpu>
void DistributedContainer<step4Local, algorithmFPType, method, cpu>::compute()
{
...
template<typename algorithmFPType, Method method, CpuType cpu>
void DistributedContainer<step4Local, algorithmFPType, method, cpu>::finalizeCompute() {}
...
template<typename algorithmFPType, Method method, CpuType cpu>
void DistributedContainer<step5Master, algorithmFPType, method, cpu>::compute()
{
    const Parameter* par = (const Parameter*)(_par);
...
template<typename algorithmFPType, Method method, CpuType cpu>
void DistributedContainer<step5Master, algorithmFPType, method, cpu>::finalizeCompute()
{
    const Parameter* par = (const Parameter*)(_par);
    DistributedStep5MasterPlusPlusPartialResult *pPartRes = static_cast<DistributedStep5MasterPlusPlusPartialResult *>(_pres);
    DistributedStep5MasterPlusPlusInput *input = static_cast<DistributedStep5MasterPlusPlusInput*>(_in);
    ...
    __DAAL_CALL_KERNEL(env, internal::KMeansinitStep5MasterKernel, __DAAL_KERNEL_ARGUMENTS(method, algorithmFPType), finalizeCompute,
        par, ntCandidates, ntWeights, pRngState, pRes->get(centroids).get());
}
