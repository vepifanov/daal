...
void checkLocalData(const data_management::DataCollection* pInput, const Parameter* par, const char* dataName,
    const data_management::NumericTable* pData, bool bParallelPlus, services::ErrorCollection* errors);
