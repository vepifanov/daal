...
template <typename algorithmFPType>
DAAL_EXPORT void DistributedStep2LocalPlusPlusPartialResult::allocate(const daal::algorithms::Input *input, const daal::algorithms::Parameter *parameter, const int method)
{
...
template <typename algorithmFPType>
DAAL_EXPORT void DistributedStep3MasterPlusPlusPartialResult::allocate(const daal::algorithms::Input *input, const daal::algorithms::Parameter *parameter, const int method)
{
    //nothing to allocate
}

template <typename algorithmFPType>
DAAL_EXPORT void DistributedStep4LocalPlusPlusPartialResult::allocate(const daal::algorithms::Input *input, const daal::algorithms::Parameter *parameter, const int method)
{
    ...
    data_management::NumericTablePtr pOutput(new data_management::HomogenNumericTable<algorithmFPType>(nFeatures,
        pInput->getNumberOfColumns(), data_management::NumericTable::doAllocate));
    set(outputOfStep4, pOutput);
}

template <typename algorithmFPType>
DAAL_EXPORT void DistributedStep5MasterPlusPlusPartialResult::allocate(const daal::algorithms::Input *input, const daal::algorithms::Parameter *parameter, const int method)
{
