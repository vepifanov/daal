                                                                            ...
                                                                            : dataTable(dataTable)
{
    ...
    if (!mean || !raw2Mom || !variance || !stDev || !variation) { _errors->add(services::ErrorMemoryAllocationFailed); return; }
...
/****************************************************************************************************************************/
template<typename algorithmFPType, CpuType cpu>
void retrievePrecomputedStatsIfPossible( size_t nFeatures,
                                         size_t nVectors,
                                         ...
                                         services::SharedPtr<services::KernelErrorCollection> &_errors)
{
    ...
    if (!precomputedSumsTable){ _errors->add(services::ErrorPrecomputedSumNotAvailable); return; }
...
void computeSumAndVariance( size_t nFeatures,
                            size_t nVectors,
                            ...
                            services::SharedPtr<services::KernelErrorCollection> &_errors )
{
    ...
    int mklStatus = Statistics<algorithmFPType, cpu>::xSumAndVariance( dataBlock,
                                                                       nFeatures,
                                                                       nVectors,
    ...
    if (mklStatus != 0){ _errors->add(services::ErrorLowOrderMomentsInternal); return; }
...
/****************************************************************************************************************************/
template<typename algorithmFPType, Method method, CpuType cpu>
void computeSum_Mean_SecondOrderRawMoment_Variance_Variation( size_t nFeatures,
                                                              size_t nVectors,
                                                              algorithmFPType *dataBlock,
                                                              algorithmFPType *sums,
                                                              algorithmFPType *mean,
                                                              ...
                                                              services::SharedPtr<services::KernelErrorCollection> &_errors )
{
    ...
    int mklStatus = Statistics<algorithmFPType, cpu>::xLowOrderMoments( dataBlock,
                                                                        nFeatures,
                                                                        nVectors,
                                                                        mklMethod,
                                                                        sums,
