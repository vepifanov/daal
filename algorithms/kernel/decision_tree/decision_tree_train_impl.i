...
protected:
                                   ...
                                   size_t minSplitSize, const IndependentVariableType * const * dx, const DependentVariableType * dy)
    {
        ...
        typedef daal::data_feature_utils::internal::EpsilonVal<typename SplitCriterion::ValueType> SplitCriterionEpsilon;
        ...
        daal::threader_for(featureCount, featureCount, [=, &localTLS, &indexes, &totalDataStatistics, &featureTypesCache, &x, &y](int featureIndex)
        {
                                  ...
                                  size_t minSplitSize, const IndependentVariableType * const * dx, const DependentVariableType * dy)
    {
        ...
        if (!workQueue.empty())
        {
            ...
            daal::threader_for(blockCount, blockCount, [=, &workArray, &indexes, &featureTypesCache, &dx, &dy, &mutex, &splitCriterion](int iBlock)
            {
                const size_t first = iBlock * rowsPerBlock;
