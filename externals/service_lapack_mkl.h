...
struct MklLapack<double, cpu>
{
    ...
    static void xpotrs(char *uplo, DAAL_INT *p, DAAL_INT *ny, double *ata, DAAL_INT *ldata, double *beta, DAAL_INT *ldaty,
                DAAL_INT *info)
    {
        __DAAL_MKLFN_CALL(lapack_, dpotrs, (uplo, p, ny, ata, ldata, beta, ldaty, info, 1));
    }

    static void xxpotrs(char *uplo, DAAL_INT *p, DAAL_INT *ny, double *ata, DAAL_INT *ldata, double *beta, DAAL_INT *ldaty,
                DAAL_INT *info)
    {
        int old_threads = fpk_serv_set_num_threads_local(1);
        __DAAL_MKLFN_CALL(lapack_, dpotrs, (uplo, p, ny, ata, ldata, beta, ldaty, info, 1));
    ...
    static void xgerqf(DAAL_INT *m, DAAL_INT *n, double *a, DAAL_INT *lda, double *tau, double *work, DAAL_INT *lwork,
                DAAL_INT *info)
    {
        __DAAL_MKLFN_CALL(lapack_, dgerqf, (m, n, a, lda, tau, work, lwork, info));
    }

    static void xxgerqf(DAAL_INT *m, DAAL_INT *n, double *a, DAAL_INT *lda, double *tau, double *work, DAAL_INT *lwork,
                DAAL_INT *info)
    {
        int old_threads = fpk_serv_set_num_threads_local(1);
        __DAAL_MKLFN_CALL(lapack_, dgerqf, (m, n, a, lda, tau, work, lwork, info));
    ...
    static void xormrq(char *side, char *trans, DAAL_INT *m, DAAL_INT *n, DAAL_INT *k, double *a, DAAL_INT *lda,
                double *tau, double *c, DAAL_INT *ldc, double *work, DAAL_INT *lwork, DAAL_INT *info)
    {
        __DAAL_MKLFN_CALL(lapack_, dormrq, (side, trans, m, n, k, a, lda, tau, c, ldc, work, lwork, info, 1, 1));
    }

    static void xxormrq(char *side, char *trans, DAAL_INT *m, DAAL_INT *n, DAAL_INT *k, double *a, DAAL_INT *lda,
                double *tau, double *c, DAAL_INT *ldc, double *work, DAAL_INT *lwork, DAAL_INT *info)
    {
        int old_threads = fpk_serv_set_num_threads_local(1);
        __DAAL_MKLFN_CALL(lapack_, dormrq, (side, trans, m, n, k, a, lda, tau, c, ldc, work, lwork, info, 1, 1));
    ...
    static void xtrtrs(char *uplo, char *trans, char *diag, DAAL_INT *n, DAAL_INT *nrhs,
                double *a, DAAL_INT *lda, double *b, DAAL_INT *ldb, DAAL_INT *info)
    {
        __DAAL_MKLFN_CALL(lapack_, dtrtrs, (uplo, trans, diag, n, nrhs, a, lda, b, ldb, info, 1, 1, 1));
    }

    static void xxtrtrs(char *uplo, char *trans, char *diag, DAAL_INT *n, DAAL_INT *nrhs,
                double *a, DAAL_INT *lda, double *b, DAAL_INT *ldb, DAAL_INT *info)
    {
        int old_threads = fpk_serv_set_num_threads_local(1);
        __DAAL_MKLFN_CALL(lapack_, dtrtrs, (uplo, trans, diag, n, nrhs, a, lda, b, ldb, info, 1, 1, 1));
    ...
    static void xgeqrf(DAAL_INT m, DAAL_INT n, double *a,
                DAAL_INT lda, double *tau, double *work, DAAL_INT lwork, DAAL_INT *info)
    {
        __DAAL_MKLFN_CALL(lapack_, dgeqrf, (&m, &n, a, &lda, tau, work, &lwork, info));
    }

    static void xxgeqrf(DAAL_INT m, DAAL_INT n, double *a,
                DAAL_INT lda, double *tau, double *work, DAAL_INT lwork, DAAL_INT *info)
    {
        int old_threads = fpk_serv_set_num_threads_local(1);
        __DAAL_MKLFN_CALL(lapack_, dgeqrf, (&m, &n, a, &lda, tau, work, &lwork, info));
    ...
    static void xgeqp3(DAAL_INT m, DAAL_INT n, double *a,
                DAAL_INT lda, DAAL_INT *jpvt, double *tau, double *work, DAAL_INT lwork, DAAL_INT *info)
    {
        __DAAL_MKLFN_CALL(lapack_, dgeqp3, (&m, &n, a, &lda, jpvt, tau, work, &lwork, info));
    }

    static void xxgeqp3(DAAL_INT m, DAAL_INT n, double *a,
                DAAL_INT lda, DAAL_INT *jpvt, double *tau, double *work, DAAL_INT lwork, DAAL_INT *info)
    {
        int old_threads = fpk_serv_set_num_threads_local(1);
        __DAAL_MKLFN_CALL(lapack_, dgeqp3, (&m, &n, a, &lda, jpvt, tau, work, &lwork, info));
    ...
    static void xorgqr(DAAL_INT m, DAAL_INT n, DAAL_INT k,
                double *a, DAAL_INT lda, double *tau, double *work, DAAL_INT lwork, DAAL_INT *info)
    {
        __DAAL_MKLFN_CALL(lapack_, dorgqr, (&m, &n, &k, a, &lda, tau, work, &lwork, info));
    }

    static void xxorgqr(DAAL_INT m, DAAL_INT n, DAAL_INT k,
                double *a, DAAL_INT lda, double *tau, double *work, DAAL_INT lwork, DAAL_INT *info)
    {
        int old_threads = fpk_serv_set_num_threads_local(1);
        __DAAL_MKLFN_CALL(lapack_, dorgqr, (&m, &n, &k, a, &lda, tau, work, &lwork, info));
    ...
    static void xgesvd(char jobu, char jobvt, DAAL_INT m, DAAL_INT n,
                double *a, DAAL_INT lda, double *s, double *u, DAAL_INT ldu, double *vt, DAAL_INT ldvt,
                double *work, DAAL_INT lwork, DAAL_INT *info)
    {
        __DAAL_MKLFN_CALL(lapack_, dgesvd, (&jobu, &jobvt, &m, &n, a, &lda, s, u, &ldu, vt, &ldvt, work, &lwork, info, 1, 1));
    }

    static void xxgesvd(char jobu, char jobvt, DAAL_INT m, DAAL_INT n,
                double *a, DAAL_INT lda, double *s, double *u, DAAL_INT ldu, double *vt, DAAL_INT ldvt,
                double *work, DAAL_INT lwork, DAAL_INT *info)
    {
        int old_threads = fpk_serv_set_num_threads_local(1);
    ...
    static void xsyevd(char *jobz, char *uplo, DAAL_INT *n, double *a, DAAL_INT *lda, double *w, double *work,
                DAAL_INT *lwork, DAAL_INT *iwork, DAAL_INT *liwork, DAAL_INT *info)
    {
        __DAAL_MKLFN_CALL(lapack_, dsyevd, (jobz, uplo, n, a, lda, w, work, lwork, iwork, liwork, info, 1, 1));
    }

    static void xxsyevd(char *jobz, char *uplo, DAAL_INT *n, double *a, DAAL_INT *lda, double *w, double *work,
                DAAL_INT *lwork, DAAL_INT *iwork, DAAL_INT *liwork, DAAL_INT *info)
    {
        int old_threads = fpk_serv_set_num_threads_local(1);
        __DAAL_MKLFN_CALL(lapack_, dsyevd, (jobz, uplo, n, a, lda, w, work, lwork, iwork, liwork, info, 1, 1));
    ...
    static void xormqr(char *side, char *trans, DAAL_INT *m, DAAL_INT *n, DAAL_INT *k, double *a, DAAL_INT *lda,
                double *tau, double *c, DAAL_INT *ldc, double *work, DAAL_INT *lwork, DAAL_INT *info)
    {
        __DAAL_MKLFN_CALL(lapack_, dormqr, (side, trans, m, n, k, a, lda, tau, c, ldc, work, lwork, info, 1, 1));
    }

    static void xxormqr(char *side, char *trans, DAAL_INT *m, DAAL_INT *n, DAAL_INT *k, double *a, DAAL_INT *lda,
                double *tau, double *c, DAAL_INT *ldc, double *work, DAAL_INT *lwork, DAAL_INT *info)
    {
        int old_threads = fpk_serv_set_num_threads_local(1);
        __DAAL_MKLFN_CALL(lapack_, dormqr, (side, trans, m, n, k, a, lda, tau, c, ldc, work, lwork, info, 1, 1));
...
struct MklLapack<float, cpu>
{
    ...
    static void xpotrs(char *uplo, DAAL_INT *p, DAAL_INT *ny, float *ata, DAAL_INT *ldata, float *beta, DAAL_INT *ldaty,
                DAAL_INT *info)
    {
        __DAAL_MKLFN_CALL(lapack_, spotrs, (uplo, p, ny, ata, ldata, beta, ldaty, info, 1));
    }

    static void xxpotrs(char *uplo, DAAL_INT *p, DAAL_INT *ny, float *ata, DAAL_INT *ldata, float *beta, DAAL_INT *ldaty,
                DAAL_INT *info)
    {
        int old_threads = fpk_serv_set_num_threads_local(1);
        __DAAL_MKLFN_CALL(lapack_, spotrs, (uplo, p, ny, ata, ldata, beta, ldaty, info, 1));
    ...
    static void xgerqf(DAAL_INT *m, DAAL_INT *n, float *a, DAAL_INT *lda, float *tau, float *work, DAAL_INT *lwork,
                DAAL_INT *info)
    {
        __DAAL_MKLFN_CALL(lapack_, sgerqf, (m, n, a, lda, tau, work, lwork, info));
    }

    static void xxgerqf(DAAL_INT *m, DAAL_INT *n, float *a, DAAL_INT *lda, float *tau, float *work, DAAL_INT *lwork,
                DAAL_INT *info)
    {
        int old_threads = fpk_serv_set_num_threads_local(1);
        __DAAL_MKLFN_CALL(lapack_, sgerqf, (m, n, a, lda, tau, work, lwork, info));
    ...
    static void xormrq(char *side, char *trans, DAAL_INT *m, DAAL_INT *n, DAAL_INT *k, float *a, DAAL_INT *lda,
                float *tau, float *c, DAAL_INT *ldc, float *work, DAAL_INT *lwork, DAAL_INT *info)
    {
        __DAAL_MKLFN_CALL(lapack_, sormrq, (side, trans, m, n, k, a, lda, tau, c, ldc, work, lwork, info, 1, 1));
    }

    static void xxormrq(char *side, char *trans, DAAL_INT *m, DAAL_INT *n, DAAL_INT *k, float *a, DAAL_INT *lda,
                float *tau, float *c, DAAL_INT *ldc, float *work, DAAL_INT *lwork, DAAL_INT *info)
    {
        int old_threads = fpk_serv_set_num_threads_local(1);
        __DAAL_MKLFN_CALL(lapack_, sormrq, (side, trans, m, n, k, a, lda, tau, c, ldc, work, lwork, info, 1, 1));
    ...
    static void xtrtrs(char *uplo, char *trans, char *diag, DAAL_INT *n, DAAL_INT *nrhs,
                float *a, DAAL_INT *lda, float *b, DAAL_INT *ldb, DAAL_INT *info)
    {
    ...
    static void xgeqrf(DAAL_INT m, DAAL_INT n, float *a,
                DAAL_INT lda, float *tau, float *work, DAAL_INT lwork, DAAL_INT *info)
    {
        __DAAL_MKLFN_CALL(lapack_, sgeqrf, (&m, &n, a, &lda, tau, work, &lwork, info));
    }

    static void xxgeqrf(DAAL_INT m, DAAL_INT n, float *a,
                DAAL_INT lda, float *tau, float *work, DAAL_INT lwork, DAAL_INT *info)
    {
        int old_threads = fpk_serv_set_num_threads_local(1);
        __DAAL_MKLFN_CALL(lapack_, sgeqrf, (&m, &n, a, &lda, tau, work, &lwork, info));
    ...
    static void xgeqp3(DAAL_INT m, DAAL_INT n, float *a,
                DAAL_INT lda, DAAL_INT *jpvt, float *tau, float *work, DAAL_INT lwork, DAAL_INT *info)
    {
        __DAAL_MKLFN_CALL(lapack_, sgeqp3, (&m, &n, a, &lda, jpvt, tau, work, &lwork, info));
    }

    static void xxgeqp3(DAAL_INT m, DAAL_INT n, float *a,
                DAAL_INT lda, DAAL_INT *jpvt, float *tau, float *work, DAAL_INT lwork, DAAL_INT *info)
    {
        int old_threads = fpk_serv_set_num_threads_local(1);
        __DAAL_MKLFN_CALL(lapack_, sgeqp3, (&m, &n, a, &lda, jpvt, tau, work, &lwork, info));
    ...
    static void xorgqr(DAAL_INT m, DAAL_INT n, DAAL_INT k,
                float *a, DAAL_INT lda, float *tau, float *work, DAAL_INT lwork, DAAL_INT *info)
    {
    ...
    static void xgesvd(char jobu, char jobvt, DAAL_INT m, DAAL_INT n,
                float *a, DAAL_INT lda, float *s, float *u, DAAL_INT ldu, float *vt, DAAL_INT ldvt,
                float *work, DAAL_INT lwork, DAAL_INT *info)
    {
    ...
    static void xsyevd(char *jobz, char *uplo, DAAL_INT *n, float *a, DAAL_INT *lda, float *w, float *work,
                DAAL_INT *lwork, DAAL_INT *iwork, DAAL_INT *liwork, DAAL_INT *info)
    {
        __DAAL_MKLFN_CALL(lapack_, ssyevd, (jobz, uplo, n, a, lda, w, work, lwork, iwork, liwork, info, 1, 1));
    }

    static void xxsyevd(char *jobz, char *uplo, DAAL_INT *n, float *a, DAAL_INT *lda, float *w, float *work,
                DAAL_INT *lwork, DAAL_INT *iwork, DAAL_INT *liwork, DAAL_INT *info)
    {
        int old_threads = fpk_serv_set_num_threads_local(1);
        __DAAL_MKLFN_CALL(lapack_, ssyevd, (jobz, uplo, n, a, lda, w, work, lwork, iwork, liwork, info, 1, 1));
    ...
    static void xormqr(char *side, char *trans, DAAL_INT *m, DAAL_INT *n, DAAL_INT *k, float *a, DAAL_INT *lda,
                float *tau, float *c, DAAL_INT *ldc, float *work, DAAL_INT *lwork, DAAL_INT *info)
    {
        __DAAL_MKLFN_CALL(lapack_, sormqr, (side, trans, m, n, k, a, lda, tau, c, ldc, work, lwork, info, 1, 1));
    }

    static void xxormqr(char *side, char *trans, DAAL_INT *m, DAAL_INT *n, DAAL_INT *k, float *a, DAAL_INT *lda,
                float *tau, float *c, DAAL_INT *ldc, float *work, DAAL_INT *lwork, DAAL_INT *info)
    {
        int old_threads = fpk_serv_set_num_threads_local(1);
        __DAAL_MKLFN_CALL(lapack_, sormqr, (side, trans, m, n, k, a, lda, tau, c, ldc, work, lwork, info, 1, 1));
