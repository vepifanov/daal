...
struct MklBlas<double, cpu>
{
    ...
    static void xsyrk(char *uplo, char *trans, DAAL_INT *p, DAAL_INT *n, double *alpha, double *a, DAAL_INT *lda,
               double *beta, double *ata, DAAL_INT *ldata)
    {
        __DAAL_MKLFN_CALL(blas_, dsyrk, (uplo, trans, p, n, alpha, a, lda, beta, ata, ldata));
    }

    static void xxsyrk(char *uplo, char *trans, DAAL_INT *p, DAAL_INT *n, double *alpha, double *a, DAAL_INT *lda,
               double *beta, double *ata, DAAL_INT *ldata)
    {
        __DAAL_MKLFN_CALL(blas_, xdsyrk, (uplo, trans, p, n, alpha, a, lda, beta, ata, ldata));
    }

    static void xsyr(const char *uplo, const DAAL_INT *n, const double *alpha,
              const double *x, const DAAL_INT *incx, double *a, const DAAL_INT *lda)
    {
        __DAAL_MKLFN_CALL(blas_, dsyr, (uplo, n, alpha, x, incx , a, lda));
    }

    static void xxsyr(const char *uplo, const DAAL_INT *n, const double *alpha,
              const double *x, const DAAL_INT *incx, double *a, const DAAL_INT *lda)
    {
    ...
    static void xgemm(char *transa, char *transb, DAAL_INT *p, DAAL_INT *ny, DAAL_INT *n, double *alpha, double *a,
               DAAL_INT *lda, double *y, DAAL_INT *ldy, double *beta, double *aty, DAAL_INT *ldaty)
    {
        __DAAL_MKLFN_CALL(blas_, dgemm, (transa, transb, p, ny, n, alpha, a, lda, y, ldy, beta, aty, ldaty));
    }

    static void xxgemm(char *transa, char *transb, DAAL_INT *p, DAAL_INT *ny, DAAL_INT *n, double *alpha, double *a,
               DAAL_INT *lda, double *y, DAAL_INT *ldy, double *beta, double *aty, DAAL_INT *ldaty)
    {
        __DAAL_MKLFN_CALL(blas_, xdgemm, (transa, transb, p, ny, n, alpha, a, lda, y, ldy, beta, aty, ldaty));
    }

    static void xsymm(char *side, char *uplo, DAAL_INT *m, DAAL_INT *n, double *alpha, double *a, DAAL_INT *lda, double *b,
               DAAL_INT *ldb, double *beta, double *c, DAAL_INT *ldc)
    {
        __DAAL_MKLFN_CALL(blas_, dsymm, (side, uplo, m, n, alpha, a, lda, b, ldb, beta, c, ldc));
    }

    static void xxsymm(char *side, char *uplo, DAAL_INT *m, DAAL_INT *n, double *alpha, double *a, DAAL_INT *lda, double *b,
               DAAL_INT *ldb, double *beta, double *c, DAAL_INT *ldc)
    {
        int old_threads = fpk_serv_set_num_threads_local(1);
        __DAAL_MKLFN_CALL(blas_, dsymm, (side, uplo, m, n, alpha, a, lda, b, ldb, beta, c, ldc));
    ...
    static void xgemv(char *trans, DAAL_INT *m, DAAL_INT *n, double *alpha, double *a, DAAL_INT *lda, double *x,
               DAAL_INT *incx, double *beta, double *y, DAAL_INT *incy)
    {
        __DAAL_MKLFN_CALL(blas_, dgemv, (trans, m, n, alpha, a, lda, x, incx, beta, y, incy));
    }

    static void xxgemv(char *trans, DAAL_INT *m, DAAL_INT *n, double *alpha, double *a, DAAL_INT *lda, double *x,
               DAAL_INT *incx, double *beta, double *y, DAAL_INT *incy)
    {
        int old_threads = fpk_serv_set_num_threads_local(1);
        __DAAL_MKLFN_CALL(blas_, dgemv, (trans, m, n, alpha, a, lda, x, incx, beta, y, incy));
    ...
    static void xxaxpy(DAAL_INT *n, double *a, double *x, DAAL_INT *incx, double *y, DAAL_INT *incy)
    {
        int old_threads = fpk_serv_set_num_threads_local(1);
        __DAAL_MKLFN_CALL(blas_, daxpy, (n, a, x, incx, y, incy));
        fpk_serv_set_num_threads_local(old_threads);
...
struct MklBlas<float, cpu>
{
    ...
    static void xsyrk(char *uplo, char *trans, DAAL_INT *p, DAAL_INT *n, float *alpha, float *a, DAAL_INT *lda, float *beta,
               float *ata, DAAL_INT *ldata)
    {
        __DAAL_MKLFN_CALL(blas_, ssyrk, (uplo, trans, p, n, alpha, a, lda, beta, ata, ldata));
    }

    static void xxsyrk(char *uplo, char *trans, DAAL_INT *p, DAAL_INT *n, float *alpha, float *a, DAAL_INT *lda, float *beta,
               float *ata, DAAL_INT *ldata)
    {
        __DAAL_MKLFN_CALL(blas_, xssyrk, (uplo, trans, p, n, alpha, a, lda, beta, ata, ldata));
    }

    static void xsyr(const char *uplo, const DAAL_INT *n, const float *alpha,
              const float *x, const DAAL_INT *incx, float *a, const DAAL_INT *lda)
    {
        __DAAL_MKLFN_CALL(blas_, ssyr, (uplo, n, alpha, x, incx , a, lda));
    }

    static void xxsyr(const char *uplo, const DAAL_INT *n, const float *alpha,
              const float *x, const DAAL_INT *incx, float *a, const DAAL_INT *lda)
    {
        int old_threads = fpk_serv_set_num_threads_local(1);
        __DAAL_MKLFN_CALL(blas_, ssyr, (uplo, n, alpha, x, incx , a, lda));
    ...
    static void xgemm(char *transa, char *transb, DAAL_INT *p, DAAL_INT *ny, DAAL_INT *n, float *alpha, float *a,
               DAAL_INT *lda, float *y, DAAL_INT *ldy, float *beta, float *aty, DAAL_INT *ldaty)
    {
        __DAAL_MKLFN_CALL(blas_, sgemm, (transa, transb, p, ny, n, alpha, a, lda, y, ldy, beta, aty, ldaty));
    }

    static void xxgemm(char *transa, char *transb, DAAL_INT *p, DAAL_INT *ny, DAAL_INT *n, float *alpha, float *a,
               DAAL_INT *lda, float *y, DAAL_INT *ldy, float *beta, float *aty, DAAL_INT *ldaty)
    {
        __DAAL_MKLFN_CALL(blas_, xsgemm, (transa, transb, p, ny, n, alpha, a, lda, y, ldy, beta, aty, ldaty));
    }

    static void xsymm(char *side, char *uplo, DAAL_INT *m, DAAL_INT *n, float *alpha, float *a, DAAL_INT *lda, float *b,
               DAAL_INT *ldb, float *beta, float *c, DAAL_INT *ldc)
    {
        __DAAL_MKLFN_CALL(blas_, ssymm, (side, uplo, m, n, alpha, a, lda, b, ldb, beta, c, ldc));
    }

    static void xxsymm(char *side, char *uplo, DAAL_INT *m, DAAL_INT *n, float *alpha, float *a, DAAL_INT *lda, float *b,
               DAAL_INT *ldb, float *beta, float *c, DAAL_INT *ldc)
    {
        int old_threads = fpk_serv_set_num_threads_local(1);
        __DAAL_MKLFN_CALL(blas_, ssymm, (side, uplo, m, n, alpha, a, lda, b, ldb, beta, c, ldc));
    ...
    static void xgemv(char *trans, DAAL_INT *m, DAAL_INT *n, float *alpha, float *a, DAAL_INT *lda, float *x, DAAL_INT *incx,
               float *beta, float *y, DAAL_INT *incy)
    {
        __DAAL_MKLFN_CALL(blas_, sgemv, (trans, m, n, alpha, a, lda, x, incx, beta, y, incy));
    }

    static void xxgemv(char *trans, DAAL_INT *m, DAAL_INT *n, float *alpha, float *a, DAAL_INT *lda, float *x, DAAL_INT *incx,
               float *beta, float *y, DAAL_INT *incy)
    {
        int old_threads = fpk_serv_set_num_threads_local(1);
        __DAAL_MKLFN_CALL(blas_, sgemv, (trans, m, n, alpha, a, lda, x, incx, beta, y, incy));
    ...
    static void xxaxpy(DAAL_INT *n, float *a, float *x, DAAL_INT *incx, float *y, DAAL_INT *incy)
    {
        int old_threads = fpk_serv_set_num_threads_local(1);
        __DAAL_MKLFN_CALL(blas_, saxpy, (n, a, x, incx, y, incy));
        fpk_serv_set_num_threads_local(old_threads);
